...
export type PkgExport = string | { import?: string; require?: string; types?: string; default?: string };
...
// ============ Leaderboard/Reputation Types ============

export type PkgActivityType = 'publish' | 'download' | 'deprecate' | 'transfer' | 'star';
