...
const templateFuncs: Record<string, (...args: unknown[]) => unknown> = {
  ...
  trimPrefix: (prefix: unknown, s: unknown) =>
    String(s).replace(new RegExp(`^${prefix}`), ''),
  trimSuffix: (suffix: unknown, s: unknown) =>
    String(s).replace(new RegExp(`${suffix}$`), ''),
  replace: (old: unknown, newStr: unknown, s: unknown) =>
    String(s).split(String(old)).join(String(newStr)),
  quote: (s: unknown) => `"${String(s)}"`,
  squote: (s: unknown) => `'${String(s)}'`,
  indent: (spaces: unknown, s: unknown) =>
    String(s)
      .split('\n')
  ...
  append: (arr: unknown, item: unknown) =>
    Array.isArray(arr) ? [...arr, item] : [item],
  prepend: (arr: unknown, item: unknown) =>
  ...
  keys: (obj: unknown) =>
    typeof obj === 'object' && obj ? Object.keys(obj) : [],
  values: (obj: unknown) =>
    typeof obj === 'object' && obj ? Object.values(obj) : [],
  ...
  merge: (...objs: unknown[]) =>
    Object.assign({}, ...objs.filter((o) => typeof o === 'object')),
  ...
  ternary: (trueVal: unknown, falseVal: unknown, cond: unknown) =>
