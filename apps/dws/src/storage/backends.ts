...
export interface BackendManager {
  ...
  uploadBatch(items: Array<{ content: Buffer; options?: UploadOptions }>): Promise<UploadResponse[]>;
...
class BackendManagerImpl implements BackendManager {
  ...
  async upload(content: Buffer, options?: UploadOptions): Promise<UploadResponse> {
  ...
  async uploadBatch(items: Array<{ content: Buffer; options?: UploadOptions }>): Promise<UploadResponse[]> {
