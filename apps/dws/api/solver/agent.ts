...
export class SolverAgent {
  ...
  async start(): Promise<void> {
    ...
    const pk = typeof process !== 'undefined' ? process.env.SOLVER_PRIVATE_KEY : undefined
    const kmsKeyId = typeof process !== 'undefined' ? process.env.SOLVER_KMS_KEY_ID : undefined
    const ownerAddress = (typeof process !== 'undefined' ? process.env.SOLVER_OWNER_ADDRESS : undefined) as Address | undefined
