...
import { WorkerAutoScaler, WorkerDeployer } from './worker-deployer'
...
export function createInfrastructure(
  ...
  const nodeRegistry = new NodeRegistry(networkConfig, config.privateKey)

  const workerDeployer = new WorkerDeployer(
    nodeRegistry,
    backendManager,
    workerdExecutor,
  )
