...
describe('Haversine Distance', () => {
  ...
  it('should calculate zero distance for same location', () => {
    router.registerNode(
      createTestNode({ nodeId: 'tokyo', region: 'ap-northeast-1' }),
    )
...
describe('IP Geolocation', () => {
  ...
  beforeEach(() => {
    ...
    router.registerNode(
      createTestNode({ nodeId: 'us-east', region: 'us-east-1' }),
    )
    router.registerNode(
      createTestNode({ nodeId: 'us-west', region: 'us-west-1' }),
    )
    router.registerNode(
      createTestNode({ nodeId: 'eu-west', region: 'eu-west-1' }),
    )
    router.registerNode(
      createTestNode({ nodeId: 'ap-ne', region: 'ap-northeast-1' }),
    )
  })
...
describe('Multiple Node Routing', () => {
  ...
  it('should return multiple candidates', () => {
    const results = router.routeMultiple(
      createRouteRequest({
        preferredRegion: 'us-east-1',
      }),
      3,
