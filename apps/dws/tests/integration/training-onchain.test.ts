 ...
 * To set up:
 *   1. Start anvil: anvil
 *   2. Deploy contracts: cd packages/contracts && forge script deploy/DeployTraining.s.sol --rpc-url http://localhost:9545 --broadcast --private-key 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80
