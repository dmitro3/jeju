...
describe('ReedSolomonCodec Configuration', () => {
  ...
  it('should reject invalid configuration', () => {
    ...
    expect(() => new ReedSolomonCodec({ dataShards: 200, parityShards: 100 })).toThrow();
  });
...
describe('ReedSolomonCodec.decode', () => {
  ...
  it('should fail when too many shards are missing', () => {
    ...
    expect(() => codec.decode(sparseShards, original.length)).toThrow(/Insufficient shards/);
  });
...
describe('ReedSolomonCodec.reconstructFromChunks', () => {
  ...
  it('should reconstruct from partial chunks', () => {
    ...
    const reconstructed = codec.reconstructFromChunks(partialChunks, original.length);
  ...
  it('should handle random data correctly', () => {
    ...
    const reconstructed = codec.reconstructFromChunks(availableChunks, original.length);
...
describe('ReedSolomonCodec.verifyMerkleProof', () => {
  ...
  it('should verify valid Merkle proofs', () => {
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      const isValid = codec.verifyMerkleProof(leaf, chunk.proof.merkleProof, root, i);
  ...
  it('should reject invalid proofs', () => {
    ...
    const isValid = codec.verifyMerkleProof(leaf, chunks[0].proof.merkleProof, wrongRoot, 0);
