...
describe('calculateNodeScore', () => {
  ...
  test('lower latency results in lower score', () => {
    ...
    expect(calculateNodeScore(fastNode)).toBeLessThan(
      calculateNodeScore(slowNode),
    )
  })
  ...
  test('lower load results in lower score', () => {
    ...
    expect(calculateNodeScore(lowLoadNode)).toBeLessThan(
      calculateNodeScore(highLoadNode),
    )
  })
