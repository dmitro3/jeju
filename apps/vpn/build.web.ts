#!/usr/bin/env bun
/**
 * VPN Web Build Script
 *
 * Builds the VPN web app for production deployment with Tailwind CSS.
 */
...
async function build(): Promise<void> {
  console.log('Building VPN web app...')
...
<head>
  ...
  <meta name="description" content="Jeju VPN - Free, decentralized VPN powered by the community" />
