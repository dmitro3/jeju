/**
 * Jeju VPN Full E2E Coverage Tests
 *
...
test.describe('Jeju VPN - Full Coverage', () => {
...
test.describe('Jeju VPN - Navigation', () => {
    ...
    test('should navigate to Connect', async ({ page, baseURL }) => {
      await page.goto(`${baseURL}/connect`)
      await page.waitForLoadState('domcontentloaded')
      await expect(page.locator('body')).toBeVisible()
    })

    test('should navigate to Settings', async ({ page, baseURL }) => {
...
test.describe('Jeju VPN - Button Interactions', () => {
...
test.describe('Jeju VPN - Form Interactions', () => {
...
test.describe('Jeju VPN - Error States', () => {
