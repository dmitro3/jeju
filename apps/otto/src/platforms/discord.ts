...
export class DiscordAdapter implements PlatformAdapter {
    ...
    this.client.on('interactionCreate', async (interaction: Interaction) => {
      ...
      if (interaction.commandName === 'otto') {
        ...
        if (!interaction.channelId || !interaction.user?.id) {
          throw new Error(
            'Invalid Discord interaction: missing required fields',
          )
        }
  ...
  async replyToMessage(
    ...
    const originalMessage = await (channel as TextChannel).messages.fetch(
      messageId,
    )
  ...
  async registerCommands(): Promise<void> {
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('command').setDescription('Command to get help for'),
        ),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('token').setDescription('Token symbol'),
        )
        .addStringOption((opt) =>
          opt.setName('chain').setDescription('Chain name'),
        ),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('token').setDescription('Token symbol').setRequired(true),
        )
        .addStringOption((opt) =>
          opt.setName('chain').setDescription('Chain name'),
        ),
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('from').setDescription('From token').setRequired(true),
        )
        .addStringOption((opt) =>
          opt.setName('to').setDescription('To token').setRequired(true),
        )
        .addStringOption((opt) =>
          opt.setName('chain').setDescription('Chain name'),
        ),
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt
            .setName('amount')
            .setDescription('Amount to bridge')
            .setRequired(true),
        )
        .addStringOption((opt) =>
          opt.setName('token').setDescription('Token symbol').setRequired(true),
        ...
        .addStringOption((opt) =>
          opt
            .setName('from_chain')
            .setDescription('Source chain')
            .setRequired(true),
        )
        .addStringOption((opt) =>
          opt
            .setName('to_chain')
            .setDescription('Destination chain')
            .setRequired(true),
        ),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt
            .setName('to')
            .setDescription('Recipient address or ENS/JNS name')
            .setRequired(true),
        ),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('supply').setDescription('Initial supply'),
        )
        .addStringOption((opt) =>
          opt.setName('liquidity').setDescription('Initial liquidity in ETH'),
        ),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub.setName('connect').setDescription('Connect your wallet'),
    )
    ...
    ottoCommand.addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt.setName('key').setDescription('Setting key'),
        )
        .addStringOption((opt) =>
          opt.setName('value').setDescription('Setting value'),
        ),
    )
  ...
  private isTextChannel(channel: Channel): channel is TextChannel | DMChannel {
