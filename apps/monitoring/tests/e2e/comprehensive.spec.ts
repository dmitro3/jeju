/**
 * Monitoring Comprehensive E2E Tests
...
const ROUTES = [
  { path: '/', name: 'Dashboard', expectedContent: 'Dashboard', description: 'Monitoring dashboard with metrics.' },
  { path: '/alerts', name: 'Alerts', expectedContent: 'Alert', description: 'Alert configuration and history.' },
  { path: '/targets', name: 'Targets', expectedContent: 'Target', description: 'Monitoring targets list.' },
  { path: '/oif', name: 'OIF Stats', expectedContent: 'OIF', description: 'OIF statistics dashboard.' },
  { path: '/query', name: 'Query Explorer', expectedContent: 'Query', description: 'Prometheus query explorer.' },
]
...
test.describe('Monitoring - All Pages', () => {
...
test.describe('Monitoring Mobile', () => {
