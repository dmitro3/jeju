...
const ROUTES = [
  {
    ...
    description: 'Monitoring dashboard with metrics.',
  },
  {
    path: '/alerts',
    name: 'Alerts',
    expectedContent: 'Alert',
  ...
  },
  {
    ...
    description: 'Monitoring targets list.',
  },
  {
    path: '/oif',
    name: 'OIF Stats',
    expectedContent: 'OIF',
    description: 'OIF statistics dashboard.',
  },
  {
    path: '/query',
    name: 'Query Explorer',
    expectedContent: 'Query',
    description: 'Prometheus query explorer.',
  },
]
