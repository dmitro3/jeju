...
export class AutocratA2AServer {
  ...
  private async executeSkill(
    ...
    switch (skillId) {
      ...
      case 'get-proposal':
        return this.getProposal(params.proposalId as string)
      case 'list-proposals':
        return this.listProposals(params.activeOnly as boolean)
      case 'back-proposal':
      ...
      case 'get-autocrat-votes':
        return this.getAutocratVotes(params.proposalId as string)
      case 'submit-vote':
      ...
      case 'get-decision':
        return this.getDecision(params.proposalId as string)
      case 'ceo-decision':
        return this.makeCEODecision(params.proposalId as string)
      case 'list-models':
        return this.listModels()
      case 'request-research':
        return this.requestResearch(params)
      case 'get-research':
        return this.getResearchResult(params.proposalId as string)
      case 'cast-veto':
