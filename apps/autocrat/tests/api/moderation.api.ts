...
test.describe('Moderation API', () => {
  ...
  test('submit flag on proposal', async ({ request }) => {
    const response = await request.post(
      `${AUTOCRAT_URL}/api/v1/moderation/flag`,
      {
        data: {
          ...
          reason:
            'Proposal lacks sufficient detail and technical specification',
          stake: 15,
  ...
  test('get proposal moderation score', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/score/${testProposalId}`,
    )
  ...
  test('vote on flag', async ({ request }) => {
    ...
    const response = await request.post(
      `${AUTOCRAT_URL}/api/v1/moderation/vote`,
      {
  ...
  test('get proposal flags', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/flags/${testProposalId}`,
    )
  ...
  test('get active flags', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/active-flags`,
    )
  ...
  test('get moderator stats', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/moderator/${testFlagger}`,
    )
  ...
  test('get moderation leaderboard', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/leaderboard?limit=5`,
    )
  ...
  test('check should-reject status', async ({ request }) => {
    const response = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/should-reject/${testProposalId}`,
    )
  ...
  test('resolve flag', async ({ request }) => {
    ...
    const response = await request.post(
      `${AUTOCRAT_URL}/api/v1/moderation/resolve`,
      {
  ...
  test('submit multiple flag types', async ({ request }) => {
    ...
    const score = await request.get(
      `${AUTOCRAT_URL}/api/v1/moderation/score/${proposalId}`,
    )
