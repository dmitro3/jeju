 ...
 */
const ROUTES = [
  { path: '/', name: 'DAO List', expectedContent: 'DAO', description: 'List of DAOs with search, filter, and create options.' },
  { path: '/create', name: 'Create DAO', expectedContent: 'Create', description: 'DAO creation wizard with name, token, and governance configuration.' },
  { path: '/my-daos', name: 'My DAOs', expectedContent: 'DAO', description: 'User-owned DAOs list.' },
]
