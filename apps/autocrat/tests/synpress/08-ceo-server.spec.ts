...
test.describe('CEO Server', () => {
  ...
  test.skipIf(!serverAvailable)('health endpoint returns CEO status', async ({ request }) => {
    const response = await request.get(`${CEO_URL}/health`);
  ...
  test.skipIf(!serverAvailable)('agent card returns CEO skills', async ({ request }) => {
  ...
  test.skipIf(!serverAvailable)('MCP tools list returns CEO tools', async ({ request }) => {
  ...
  test.skipIf(!serverAvailable)('MCP resources list returns council resources', async ({ request }) => {
  ...
  test.skipIf(!serverAvailable)('A2A chat skill responds', async ({ request }) => {
  ...
  test.skipIf(!serverAvailable)('A2A get-dashboard skill returns governance data', async ({ request }) => {
    const response = await request.post(`${CEO_URL}/a2a`, {
      data: {
        jsonrpc: '2.0',
        id: 1,
  ...
  test.skipIf(!serverAvailable)('MCP tool call works', async ({ request }) => {
