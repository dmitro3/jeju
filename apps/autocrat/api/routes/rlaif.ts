...
const TrajectoryStepSchema = t.Object({
  ...
  action: t.String(),
  reward: t.Number(),
  metadata: t.Record(t.String(), JsonValueSchema),
})
...
const RolloutInputSchema = t.Object({
  ...
  steps: t.Array(
    t.Object({
      ...
      observation: t.Union([t.String(), t.Record(t.String(), JsonValueSchema)]),
      action: t.Union([
        t.String(),
        t.Object({
          type: t.String(),
          parameters: t.Optional(t.Record(t.String(), JsonValueSchema)),
          reasoning: t.Optional(t.String()),
        }),
      ]),
      reward: t.Number(),
      done: t.Optional(t.Boolean()),
      llmCalls: t.Optional(t.Array(JsonValueSchema)),
    }),
  ),
  totalReward: t.Optional(t.Number()),
  metadata: t.Optional(t.Record(t.String(), JsonValueSchema)),
})
  ...
  .post(
    ...
    },
    {
      ...
      detail: {
        ...
        description: 'Adds trajectories to a specific training run',
      },
    },
  )
  .get(
