...
describe('calculateTotalValue', () => {
  ...
  test('should sum YES and NO shares for single position', () => {
    const positions = [
      createPosition({ yesShares: parseEther('100'), noShares: parseEther('50') }),
    ];
  ...
  test('should sum across multiple positions', () => {
    const positions = [
      ...
      createPosition({ yesShares: parseEther('25'), noShares: parseEther('25') }),
    ];
...
describe('calculatePositionCurrentValue', () => {
  test('should return both shares for active market', () => {
    const position = createPosition({
      yesShares: parseEther('100'),
      noShares: parseEther('50'),
      market: { sessionId: '0x1', question: 'Test?', resolved: false, outcome: undefined },
    });
  ...
  test('should return YES shares for resolved YES market', () => {
    const position = createPosition({
      yesShares: parseEther('100'),
      noShares: parseEther('50'),
      market: { sessionId: '0x1', question: 'Test?', resolved: true, outcome: true },
    });
  ...
  test('should return NO shares for resolved NO market', () => {
    const position = createPosition({
      yesShares: parseEther('100'),
      noShares: parseEther('50'),
      market: { sessionId: '0x1', question: 'Test?', resolved: true, outcome: false },
    });
...
describe('countActivePositions', () => {
  ...
  test('should count only active positions', () => {
    const positions = [
      createPosition({ market: { sessionId: '0x1', question: 'A?', resolved: false, outcome: undefined } }),
      createPosition({ market: { sessionId: '0x2', question: 'B?', resolved: true, outcome: true } }),
      createPosition({ market: { sessionId: '0x3', question: 'C?', resolved: false, outcome: undefined } }),
    ];
  ...
  test('should return 0 when all resolved', () => {
    const positions = [
      createPosition({ market: { sessionId: '0x1', question: 'A?', resolved: true, outcome: true } }),
      createPosition({ market: { sessionId: '0x2', question: 'B?', resolved: true, outcome: false } }),
    ];
...
describe('filterClaimablePositions', () => {
  ...
  test('should filter claimable YES winners', () => {
    const positions = [
      createPosition({
        id: 'claimable',
        yesShares: parseEther('100'),
        market: { sessionId: '0x1', question: 'A?', resolved: true, outcome: true },
        hasClaimed: false,
      }),
      createPosition({
        id: 'already-claimed',
        yesShares: parseEther('50'),
        market: { sessionId: '0x2', question: 'B?', resolved: true, outcome: true },
        hasClaimed: true,
      }),
    ];
  ...
  test('should filter claimable NO winners', () => {
    const positions = [
      createPosition({
        ...
        market: { sessionId: '0x1', question: 'A?', resolved: true, outcome: false },
        hasClaimed: false,
      }),
    ];
    const result = filterClaimablePositions(positions);
  ...
  test('should exclude active positions', () => {
    const positions = [
      createPosition({
        yesShares: parseEther('100'),
        market: { sessionId: '0x1', question: 'A?', resolved: false, outcome: undefined },
        hasClaimed: false,
      }),
    ];
    expect(filterClaimablePositions(positions)).toEqual([]);
...
describe('filterActivePositions', () => {
  test('should return only active positions', () => {
    const positions = [
      createPosition({ id: 'active', market: { sessionId: '0x1', question: 'A?', resolved: false, outcome: undefined } }),
      createPosition({ id: 'resolved', market: { sessionId: '0x2', question: 'B?', resolved: true, outcome: true } }),
    ];
  ...
  test('should calculate complete stats', () => {
    const positions = [
      ...
      createPosition({
        ...
        market: { sessionId: '0x3', question: 'C?', resolved: true, outcome: false },
        hasClaimed: false,
      }),
    ];
