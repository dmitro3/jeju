  ...
  return (
    <div className="max-w-4xl mx-auto py-12">
      <div className="mb-12">
        <Link
          href="/coins/jeju-ico"
          className="text-bazaar-primary hover:underline text-sm mb-4 inline-block"
        >
        ...
        <p className="text-xl" style={{ color: 'var(--text-secondary)' }}>
          Technical documentation for JEJU, the governance and utility token of
          the Network.
        </p>
      </div>
        ...
        <ul className="space-y-2 text-sm">
          {[
            ...
            <li key={item}>
              <a
                href={`#section-${i + 1}`}
                className="hover:text-bazaar-primary transition-colors"
      ...
      <Section id="section-1" title="1. Abstract">
        <p>
          the network is an OP-Stack L2 with 200ms Flashblocks. JEJU is the
          governance and utility token.
        </p>
        <p className="mt-4">
          Any token can be used for payments via paymaster. JEJU provides
          exclusive access to governance and moderation staking.
        </p>
      </Section>
      ...
      <Section id="section-2" title="2. the network Overview">
        ...
        >
          <li>
            <strong>200ms Flashblocks</strong> - Near-instant finality
          </li>
          <li>
            <strong>ERC-4337 Account Abstraction</strong> - Gasless transactions
          </li>
          <li>
            <strong>EIL Cross-chain Bridging</strong> - Ethereum Interop Layer
          </li>
          <li>
            <strong>ERC-7683 Intents</strong> - Cross-chain execution
          </li>
        </ul>
        ...
        >
          <li>
            <strong>Compute:</strong> Inference with x402 micropayments
          </li>
          <li>
            <strong>Storage:</strong> IPFS-compatible pinning
          </li>
          <li>
            <strong>Bazaar:</strong> NFT and token marketplace
          </li>
          <li>
            <strong>Identity:</strong> On-chain registry (ERC-8004)
          </li>
        </ul>
      </Section>
      ...
      <Section id="section-3" title="3. Token Utility">
        <div className="grid md:grid-cols-2 gap-4 my-6">
          ...
          <UtilityCard
            title="💻 Services"
            description="Pay via paymaster (any token)"
          />
          <UtilityCard
            title="👥 Council"
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          Any registered token with a paymaster can be used for payments. JEJU
          is exclusive for governance and moderation staking.
        </p>
      </Section>
      ...
      <Section id="section-4" title="4. Tokenomics">
        <div className="overflow-x-auto my-6">
          <table className="w-full text-sm">
            ...
            >
              {Object.entries(JEJU_TOKENOMICS.allocation).map(
                ([key, value]) => (
                  <tr key={key}>
                    <td
      ...
      <Section id="section-5" title="5. Governance">
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          Multi-sig treasury receiving network revenue for:
        </p>
        <ul
      ...
      <Section id="section-6" title="6. Moderation Marketplace">
        <p style={{ color: 'var(--text-secondary)' }}>
          Futarchy-based ban decisions via prediction markets. Banned users JEJU
          stakes are locked until appeal resolved.
        </p>
      ...
      <Section id="section-9" title="9. Contact">
        ...
        >
          <li>
            ...
            >
              github.com/elizaos/jeju
            </a>
          </li>
          <li>
            <strong>Security:</strong> security@jejunetwork.org
          </li>
          <li>
            <strong>Legal:</strong> legal@jejunetwork.org
          </li>
        </ul>
      </Section>
      ...
      <div className="card p-6 mt-12">
        ...
        <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>
          Not financial advice. JEJU is a utility token with no ownership
          rights. You may lose your entire investment.
        </p>
