...
export const metadata: Metadata = {
  ...
  description:
    'Participate in the Babylon (BBLN) token sale via Continuous Clearing Auction. Fair price discovery, ELIZA holder bonus, instant liquidity at TGE.',
  openGraph: {
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-lg text-amber-100/70 md:text-xl">
              ...
              <br />
              Fair price discovery. Same clearing price for all. ELIZA holder
              bonus.
            </p>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-amber-500/20 bg-black/40 p-6">
                <h2 className="mb-4 text-xl font-bold text-amber-100">
                ...
                <ol className="space-y-3 text-sm text-amber-100/70">
                  <li className="flex gap-3">
                    ...
                    <span>
                      Price starts high and decreases over time (reverse Dutch
                      auction)
                    </span>
                  </li>
                  <li className="flex gap-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Tokens are distributed immediately - 100% liquid at TGE
                    </span>
                  </li>
                </ol>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-100/70">
                      Hold ELIZA OS tokens to receive a 1.5x allocation bonus on
                      your BBLN purchase. Early bird bidders during the priority
                      window also receive additional benefits.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-8 text-center text-2xl font-bold text-amber-100">
              FAQ
            </h2>
