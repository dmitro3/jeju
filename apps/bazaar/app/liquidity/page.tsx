...
export default function LiquidityPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div
        className="card p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3"
        style={{ borderColor: 'var(--border)' }}
      >
        <div>
          <p className="font-medium" style={{ color: 'var(--text-primary)' }}>
            Looking for single-chain pools?
          </p>
          <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>
            Add liquidity to regular trading pools
          </p>
        </div>
      ...
      <div className="card p-5 md:p-6 mb-6">
        ...
        >
          <div className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-bazaar-primary/20 text-bazaar-primary flex items-center justify-center text-xs font-bold shrink-0">
              1
            </span>
            <div>
              ...
              — Your liquidity is split between local pools (70%) and
              cross-chain transport (30%)
            </div>
          </div>
          <div className="flex gap-3">
            <span className="w-6 h-6 rounded-full bg-bazaar-primary/20 text-bazaar-primary flex items-center justify-center text-xs font-bold shrink-0">
            ...
            <div>
              <strong style={{ color: 'var(--text-primary)' }}>
                Earn from both sources
              </strong>{' '}
              — Swap fees from local trades + bridge fees from cross-chain
              transfers
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              ...
              — No lock-up period, flexible liquidity management
            </div>
          </div>
        </div>
      </div>
