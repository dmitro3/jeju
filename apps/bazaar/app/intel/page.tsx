...
function generateSampleCrossChainPrices(): CrossChainPrice[] {
  return [
    ...
    {
      token: 'USDC',
      prices: { 1: 1.0001, 8453: 1.0, 42161: 0.9999, 10: 1.0, 56: 0.9998 },
      spread: 0.03,
      arbitrageOpportunity: false,
    },
    {
          ...
          <tbody>
            {prices.map((price) => (
              ...
              >
                ...
                <td
                  className={`p-3 text-right font-semibold ${price.spread > 0.5 ? 'text-green-400' : ''}`}
                >
            ...
            <div key={i} className="p-3 flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-xs font-semibold uppercase ${actionColors[whale.action]}`}
                  >
                    {whale.action}
                  </span>
                </div>
      ...
      {IS_DEMO_MODE && (
        <div className="mb-4 p-3 rounded-xl border border-yellow-500/30 bg-yellow-500/10">
          <div className="flex items-center gap-2 text-yellow-400 text-sm">
            <span>⚠️</span>
            <span>
              Demo Mode: Showing sample data. Connect to live feeds for real
              market intelligence.
            </span>
          </div>
        </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
          {IS_DEMO_MODE
            ...
            : 'Real-time market intelligence across chains'}
        </p>
      </div>
