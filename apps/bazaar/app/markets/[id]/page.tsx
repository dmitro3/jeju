    ...
    <div>
      ...
      <div className="mb-8">
        ...
        >
          ...
          <span>
            Volume: {(Number(market.totalVolume) / 1e18).toLocaleString()} ETH
          </span>
          {market.resolved && market.outcome !== undefined && (
            <>
              ...
              <span
                className={
                  market.outcome ? 'text-bazaar-success' : 'text-bazaar-error'
                }
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-xl md:text-2xl font-bold text-bazaar-success">
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-xl md:text-2xl font-bold text-bazaar-error">
                    {noPercent.toFixed(1)}%
                  </span>
                </div>
                <div className="progress-bar h-3">
          ...
          {!market.resolved && <TradingInterface market={market} />}
          ...
          {market.resolved && market.outcome !== undefined && (
            <div className="card p-5 md:p-6">
              ...
              <div
                className={`text-center py-6 rounded-xl font-bold text-xl ${
                  market.outcome
