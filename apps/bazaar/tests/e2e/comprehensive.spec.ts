...
const ROUTES = [
  {
    path: '/',
    name: 'Home',
    expectedContent: 'Bazaar',
    description: 'Bazaar home page with DeFi navigation and trending content.',
  },
  {
    path: '/swap',
    name: 'Swap',
    expectedContent: 'Swap',
    description: 'Token swap interface with token selectors and price display.',
  },
  {
    path: '/pools',
    name: 'Pools',
    expectedContent: 'Pool',
    description: 'Liquidity pools list with APY and TVL stats.',
  },
  {
    path: '/perps',
    name: 'Perps',
    expectedContent: 'Perp',
    description: 'Perpetuals trading interface with charts and order book.',
  },
  {
    path: '/coins',
    name: 'Coins',
    expectedContent: 'Coin',
    description: 'Token listings with market data and charts.',
  },
  {
    path: '/coins/create',
    name: 'Create Coin',
    expectedContent: 'Create',
    description: 'Token creation wizard with parameters.',
  },
  {
    path: '/coins/launch',
    name: 'Launch Coin',
    expectedContent: 'Launch',
    description: 'Token launch wizard for bonding curves.',
  },
  {
    path: '/coins/jeju-ico',
    name: 'Jeju ICO',
    expectedContent: 'JEJU',
    description: 'Jeju token ICO page with purchase options.',
  },
  {
    path: '/markets',
    name: 'Markets',
    expectedContent: 'Market',
    description: 'Markets overview with prediction markets and perps.',
  },
  {
    path: '/markets/create',
    name: 'Create Market',
    expectedContent: 'Create',
    description: 'Prediction market creation wizard.',
  },
  {
    path: '/markets/predictions',
    name: 'Predictions',
    expectedContent: 'Prediction',
    description: 'Prediction markets list with outcomes.',
  },
  {
    path: '/items',
    name: 'Items',
    expectedContent: 'Item',
    description: 'NFT marketplace with collections and listings.',
  },
  {
    path: '/items/mint',
    name: 'Mint Item',
    expectedContent: 'Mint',
  ...
  },
  {
    ...
    description: 'JNS domain registration and management.',
  },
  {
    path: '/liquidity',
    name: 'Liquidity',
  ...
  },
  {
    path: '/tfmm',
    name: 'TFMM',
    expectedContent: 'TFMM',
    description: 'Token-weighted AMM interface.',
  },
  {
    path: '/portfolio',
    name: 'Portfolio',
    expectedContent: 'Portfolio',
    description: 'User portfolio with balances and positions.',
  },
  {
    path: '/rewards',
    name: 'Rewards',
    expectedContent: 'Reward',
    description: 'Rewards dashboard with claimable rewards.',
  },
  {
    path: '/settings',
    name: 'Settings',
  ...
  },
  {
    path: '/trending',
    name: 'Trending',
    expectedContent: 'Trend',
    description: 'Trending tokens and markets.',
  },
]
