...
export const CHAIN_ID = parseInt(
  process.env.NEXT_PUBLIC_CHAIN_ID || getDefaultChainId(),
  10,
)
...
export const INDEXER_URL =
  process.env.NEXT_PUBLIC_INDEXER_URL || getDefaultIndexerUrl()
export const EXPLORER_URL =
  process.env.NEXT_PUBLIC_EXPLORER_URL || getDefaultExplorerUrl()
export const IPFS_API_URL =
  process.env.NEXT_PUBLIC_JEJU_IPFS_API || getDefaultIpfsApiUrl()
export const IPFS_GATEWAY_URL =
  process.env.NEXT_PUBLIC_JEJU_IPFS_GATEWAY || getDefaultIpfsGatewayUrl()
export const OIF_AGGREGATOR_URL =
  process.env.NEXT_PUBLIC_OIF_AGGREGATOR_URL || getDefaultOifAggregatorUrl()
...
export const CONTRACTS = {
  ...
  moderationMarketplace: (process.env
    .NEXT_PUBLIC_MODERATION_MARKETPLACE_ADDRESS || ZERO) as Address,
  reportingSystem: (process.env.NEXT_PUBLIC_REPORTING_SYSTEM_ADDRESS ||
    ZERO) as Address,
  reputationLabelManager: (process.env
    .NEXT_PUBLIC_REPUTATION_LABEL_MANAGER_ADDRESS || ZERO) as Address,
  labelManager: (process.env.NEXT_PUBLIC_LABEL_MANAGER_ADDRESS ||
    ZERO) as Address,
  ...
  // Perpetuals
  perpetualMarket: (process.env.NEXT_PUBLIC_PERPETUAL_MARKET_ADDRESS ||
    ZERO) as Address,
  marginManager: (process.env.NEXT_PUBLIC_MARGIN_MANAGER_ADDRESS ||
    ZERO) as Address,
  ...
  // Oracle Network
  oracleStakingManager: (process.env
    .NEXT_PUBLIC_ORACLE_STAKING_MANAGER_ADDRESS || ZERO) as Address,
  priceFeedAggregator: (process.env.NEXT_PUBLIC_PRICE_FEED_AGGREGATOR_ADDRESS ||
    ZERO) as Address,
} as const
...
export const SOLANA_RPC_URL =
  process.env.NEXT_PUBLIC_SOLANA_RPC_URL || getSolanaRpcUrl()
export const SOLANA_CHAIN_ID =
  process.env.NEXT_PUBLIC_SOLANA_CHAIN_ID === 'mainnet' ? 101 : 102
...
export const BAZAAR_PAYMENT_RECIPIENT = (process.env
  .NEXT_PUBLIC_BAZAAR_PAYMENT_RECIPIENT || ZERO) as Address
