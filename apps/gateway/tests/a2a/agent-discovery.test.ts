    ...
    const request = {
      ...
      params: {
        message: {
          ...
          parts: [{ kind: 'data', data: { skillId: 'list-protocol-tokens' } }],
        },
      },
      id: 3,
    }
    ...
    const request = {
      ...
      params: {
        message: {
          ...
          parts: [{ kind: 'data', data: { skillId: 'get-node-stats' } }],
        },
      },
      id: 4,
    }
    ...
    const request = {
      ...
      params: {
        message: {
          ...
          parts: [{ kind: 'data', data: { skillId: 'list-nodes' } }],
        },
      },
      id: 5,
    }
    ...
    const request = {
      ...
      params: {
        message: {
          ...
          parts: [{ kind: 'data', data: { skillId: 'list-registered-apps' } }],
        },
      },
      id: 6,
    }
