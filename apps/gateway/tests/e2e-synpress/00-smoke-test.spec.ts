...
test.describe('Gateway Smoke Tests', () => {
  test('homepage should load without errors', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-00-homepage.png',
      fullPage: true,
    })
  })
  ...
  test('should connect MetaMask wallet', async ({ page, metamask }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-00-connected.png',
      fullPage: true,
    })
  })

  test('should load all protocol tokens', async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  test('all navigation tabs should be clickable', async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  test('should maintain wallet connection across navigation', async ({
    context,
    page,
    metamaskPage,
    extensionId,
