...
test.describe('Gateway Wallet Connection', () => {
  test('should display homepage and connect wallet', async ({
    page,
    metamask,
  }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-01-before-connect.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-02-wallet-connected.png',
      fullPage: true,
    })
  })

  test('should display all protocol token balances', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-03-token-balances.png',
      fullPage: true,
    })
  })
  ...
  test('should maintain wallet connection across tabs', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
