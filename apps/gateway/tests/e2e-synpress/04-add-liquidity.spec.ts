...
test.describe('Add Liquidity Flow', () => {
  ...
  test('should display add liquidity interface', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/synpress-liquidity-interface.png',
      fullPage: true,
    })
  })
  ...
  test('should display LP position if exists', async ({ page }) => {
    ...
    if (hasPosition) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/synpress-lp-position.png',
        fullPage: true,
      })
    } else {
  ...
  test.skip('should add liquidity successfully', async ({ page, metamask }) => {
    ...
    // Wait for success
    await expect(page.getByText(/Liquidity added successfully/i)).toBeVisible({
      timeout: 60000,
    })
...
test.describe('LP Dashboard', () => {
  ...
  test('should display LP dashboard', async ({ page }) => {
    ...
    // Screenshot
    await page.screenshot({
      path: 'test-results/screenshots/synpress-lp-dashboard.png',
      fullPage: true,
    })
  })
  ...
  test('should show claim fees button for positions with pending fees', async ({
    page,
  }) => {
  ...
  test.skip('should claim fees successfully', async ({ page, metamask }) => {
    ...
    // Wait for success
    await expect(page.getByText(/Fees claimed successfully/i)).toBeVisible({
      timeout: 60000,
    })
