...
test.describe('Complete Protocol Flow', () => {
  test('full token lifecycle: register → deploy → add liquidity → earn fees', async ({
    page,
    wallet,
  }) => {
  ...
  test('bridge → deploy → liquidity → earnings flow', async ({
    page,
    wallet,
  }) => {
    await page.goto('http://localhost:4001')
  ...
  test('node staking complete flow: stake → register → monitor → claim', async ({
    page,
    wallet,
  }) => {
    await page.goto('http://localhost:4001')
  ...
  test('app registry complete flow: browse → register → discover', async ({
    page,
    wallet,
  }) => {
    await page.goto('http://localhost:4001')
