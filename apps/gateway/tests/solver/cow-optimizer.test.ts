...
describe('Direct Routing', () => {
  ...
  it('should route USDC to WETH through direct pool', () => {
    ...
    if (solution) {
      ...
      expect(solution.trades[0].executedBuyAmount).toBeGreaterThan(
...
describe('Solution Quality', () => {
  ...
  it('should calculate solution stats correctly', () => {
    ...
    if (solution) {
      ...
      expect(stats.directRoutes + stats.multiHopRoutes + stats.cowMatches).toBe(
...
describe('Report Generation', () => {
  it('should print optimization report without errors', () => {
    ...
    const solution = {
      ...
      trades: [
        {
          orderUid: '0x01' as `0x${string}`,
          executedSellAmount: BigInt(1000),
          executedBuyAmount: BigInt(999),
        },
        {
          orderUid: '0x02' as `0x${string}`,
          executedSellAmount: BigInt(2000),
          executedBuyAmount: BigInt(1998),
        },
      ],
      interactions: [],
      prices: {},
      routing: [
        ...
        },
        {
          orderUid: '0x02' as `0x${string}`,
          path: [USDC, USDT, WETH],
          type: 'multi-hop' as const,
          surplusBps: 12,
        },
      ],
      totalSurplusUsd: 45.5,
