...
test.describe('EIL Cross-Chain Transfer', () => {
  ...
  test('should display EIL stats when navigating to transfer tab', async ({
    page,
  }) => {
  ...
  test('should display cross-chain transfer form', async ({ page }) => {
    ...
    await expect(
      page.locator('text=Instant Cross-Chain Transfer'),
    ).toBeVisible()
  ...
  test('should disable transfer button when amount is empty', async ({
    page,
  }) => {
    await page.click('text=Cross-Chain Transfer')
  ...
  test('should show EIL not configured message when contracts not deployed', async ({
    page,
  }) => {
    ...
    const hasForm = await page
      .locator('text=Instant Cross-Chain Transfer')
      .isVisible()
    const hasWarning = await page
      .locator('text=EIL (Ethereum Interop Layer) is not configured')
      .isVisible()
...
test.describe('XLP Dashboard', () => {
  ...
  test('should show registration form for new XLPs', async ({ page }) => {
    ...
    const hasStakeManagement = await page
      .locator('text=Active Stake')
      .isVisible()
