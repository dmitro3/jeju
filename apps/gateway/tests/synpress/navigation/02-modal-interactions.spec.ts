...
test.describe('App Detail Modal', () => {
  ...
  test('should open app detail modal when clicking app card', async ({
    page,
  }) => {
    // Find app cards
  ...
  test('should display all app details in modal', async ({ page }) => {
    ...
    await expect(
      modal.getByText(
        /Description|Categories|A2A Endpoint|Stake Information|Owner/i,
      ),
    ).toBeVisible()
  ...
  test('should show owner actions only for owner', async ({ page }) => {
    ...
    if (isOwner) {
      ...
      await expect(
        modal.getByRole('button', { name: /Edit Details|Withdraw/i }),
      ).toBeVisible()
...
test.describe('RainbowKit Wallet Modal', () => {
  ...
  test.skip('should open account modal when clicking connected address', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Transaction Confirmation Modal (MetaMask)', () => {
  test('should display MetaMask confirmation for transactions', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Loading and Transition States', () => {
  ...
  test('should show skeleton loaders for balance cards', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Mobile Navigation', () => {
  test.skip('should show hamburger menu on mobile viewport', async ({
    page,
    metamask,
  }) => {
