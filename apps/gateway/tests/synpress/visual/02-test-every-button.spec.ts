...
test.describe('EVERY BUTTON TEST - Complete Button Coverage', () => {
  test('MASTER: Click and test every button in Gateway', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    const nodeButtons = [/Network Overview/i, /My Nodes/i, /Register New Node/i]
    ...
    const registryButtons = [/Browse Apps/i, /Register App/i]
    ...
    const modeButtons = [/Select Token/i, /Custom Address/i]
