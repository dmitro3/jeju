...
test.describe('EVERY FORM TEST - Complete Form Validation', () => {
  test('MASTER: Test all forms and inputs across Gateway', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    if (await tokenAddressInput.isVisible()) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/visual-forms/01-register-token-filled.png',
        fullPage: true,
      })
    }
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual-forms/02-bridge-form-filled.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual-forms/03-deploy-paymaster-configured.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual-forms/04-add-liquidity-filled.png',
      fullPage: true,
    })
    ...
    await page
      ...
      .fill('https://node.example.com:8545')
    await page.waitForTimeout(300)
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual-forms/05-register-node-filled.png',
      fullPage: true,
    })
    ...
    await page
      ...
      .fill('Testing all form fields')
    await page
      .getByPlaceholder('https://myapp.com/a2a')
      .fill('http://localhost:4003/a2a')
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual-forms/06-register-app-filled.png',
      fullPage: true,
    })
...
test.describe('Form Field Validation - All Inputs', () => {
  test('should test all input types across all forms', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
    ...
    const total =
      textInputs + numberInputs + rangeInputs + selectInputs + textareas
