...
async function validateNoErrors(page: Page, screenName: string) {
  ...
  const isGoodError =
    bodyText?.toLowerCase().includes('no error') ||
...
test.describe('COMPLETE VISUAL VALIDATION - Every Screen', () => {
  test('MASTER: Screenshot and validate EVERY screen in Gateway', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/01-homepage-disconnected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/02-connect-modal.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/03-homepage-connected.png',
      fullPage: true,
    })
    ...
    // ===================
    await page.screenshot({
      path: 'test-results/screenshots/visual/04-token-balances-detail.png',
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/05-registered-tokens.png',
      fullPage: true,
    })
    ...
    if (await registerSection.isVisible()) {
      ...
      await page.screenshot({
        path: 'test-results/screenshots/visual/06-register-token-form.png',
        fullPage: true,
      })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/07-bridge-tab.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/08-bridge-token-dropdown.png',
      fullPage: true,
    })
    ...
    // ===================
    await page.screenshot({
      path: 'test-results/screenshots/visual/09-bridge-token-selected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/10-bridge-custom-mode.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/11-deploy-paymaster.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/12-deploy-token-dropdown.png',
      fullPage: true,
    })
    ...
    // ===================
    await page.screenshot({
      path: 'test-results/screenshots/visual/13-deploy-with-slider.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/14-add-liquidity.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/15-liquidity-token-dropdown.png',
      fullPage: true,
    })
    ...
    // ===================
    await page.screenshot({
      path: 'test-results/screenshots/visual/16-liquidity-token-selected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/17-my-earnings.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/18-node-operators.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/19-network-overview.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/20-my-nodes.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/21-register-node.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/22-staking-token-dropdown.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/23-reward-token-dropdown.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/24-app-registry.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/25-browse-apps.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/33-register-app.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/34-app-tags-selected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/35-app-stake-dropdown.png',
      fullPage: true,
    })
    ...
    // ===================
    await page.screenshot({
      path: 'test-results/screenshots/visual/36-app-form-filled.png',
      fullPage: true,
    })
    ...
    console.log(
      `   ✅ ${screenshots.length} screens validated (no errors/failed)`,
    )
