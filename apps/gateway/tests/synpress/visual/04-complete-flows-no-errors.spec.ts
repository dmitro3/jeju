...
async function assertNoErrorsOnPage(page: Page, stepName: string) {
  ...
  const hasErrorBoundary = await page
    .locator('text=/Error Boundary|Component Error/i')
    .isVisible()
  if (hasErrorBoundary) {
...
test.describe('COMPLETE USER JOURNEY - No Errors', () => {
  test('FLOW: New User → View Tokens → Browse Apps → Check Nodes', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/01-homepage.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/02-connected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/03-balances.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/04-token-list.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/05-bridge.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/06-bridge-selected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/07-deploy.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/08-liquidity.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/visual/09-earnings.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/10-network-overview.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/11-my-nodes.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/12-register-node.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/13-browse-apps.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/flows-no-errors/14-register-app.png',
      fullPage: true,
    })
  ...
  test('FLOW: Power User → All Features → All Sub-Sections', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    const steps = [
      ...
      },
      {
        ...
        action: async () => {
          await page
            .getByRole('button', { name: /Bridge from Ethereum/i })
            .click()
        },
      },
      {
        name: 'Deploy Paymaster',
        action: async () => {
          await page.getByRole('button', { name: /Deploy Paymaster/i }).click()
        },
      },
...
test.describe('Error Detection - Comprehensive', () => {
  test('should detect and report any errors in console', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
