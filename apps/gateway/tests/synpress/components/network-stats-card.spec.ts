...
test.describe('Network Statistics Display', () => {
  ...
  test('should display actual stat values', async ({ page }) => {
    const totalNodesElement = page
      ...
      .locator('p')
      .nth(1)
    const totalStakedElement = page
      .locator('p:has-text("Total Staked")')
      .locator('../..')
      .locator('p')
      .nth(1)
    const totalRewardsElement = page
      .locator('p:has-text("Rewards Claimed")')
      .locator('../..')
      .locator('p')
      .nth(1)
    ...
    // All should be >= 0
    expect(parseInt(totalNodes || '0', 10)).toBeGreaterThanOrEqual(0)
  ...
  test('should show warning when approaching ownership limit', async ({
    page,
  }) => {
...
test.describe('Network Stats Real-Time Updates', () => {
  test.skip('should update stats after node registration', async ({
    page: _page,
  }) => {
  ...
  test.skip('should update stats after rewards claimed', async ({
    page: _page,
  }) => {
