...
async function connectWallet(
  ...
  await page.waitForSelector('button:has-text(/0x/)', {
...
test.describe('Wallet Connection Tests', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`wallet connects correctly on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Main Tab Navigation - Desktop', () => {
  test('all main tabs clickable and switch content', async ({
    context,
    page,
    metamaskPage,
    extensionId,
...
test.describe('Main Tab Navigation - Mobile', () => {
  test('all main tabs clickable on mobile viewport', async ({
    context,
    page,
    metamaskPage,
    extensionId,
...
test.describe('Nodes Tab - All Sub-buttons', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`nodes sub-tabs work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Registry Tab - All Sub-buttons', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`registry sub-tabs work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Intents Tab - All Sub-buttons', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`intents sub-tabs work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('XLP Tab - All Sub-buttons', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`XLP sub-tabs work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Transfer Tab - Chain Selector', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`destination chain buttons work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Tokens Tab - Refresh Button', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`refresh button works on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Registry - Filter Buttons', () => {
  for (const [name, viewport] of Object.entries(VIEWPORTS)) {
    test(`filter buttons work on ${name}`, async ({
      context,
      page,
      metamaskPage,
      extensionId,
...
test.describe('Complete Button Audit', () => {
  test('MASTER: Count and click every button - Desktop', async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  test('MASTER: Count and click every button - Mobile', async ({
    context,
    page,
    metamaskPage,
    extensionId,
...
test.describe('Responsive Layout Verification', () => {
  test('header responsive - logo and connect visible on mobile', async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  test('navigation grid responsive - all tabs visible without horizontal scroll', async ({
    context,
    page,
    metamaskPage,
    extensionId,
  ...
  test('cards stack on mobile', async ({
    context,
    page,
    metamaskPage,
    extensionId,
