...
test.describe('Gateway Basic Tests', () => {
  test('complete smoke test', async ({
    context,
    page,
    metamaskPage,
    extensionId,
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/01-homepage.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/02-wallet-connected.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/03-tokens-loaded.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/04-bridge-tab.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/05-liquidity-tab.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/06-nodes-tab.png',
      fullPage: true,
    })
    ...
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/07-registry-tab.png',
      fullPage: true,
    })
    ...
    await expect(page.locator('button:has-text(/0x/)')).toBeVisible()
    await page.screenshot({
      path: 'test-results/screenshots/gateway/smoke/08-final-state.png',
      fullPage: true,
    })
