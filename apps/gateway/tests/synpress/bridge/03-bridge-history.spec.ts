...
test.describe('Bridge History Component', () => {
  ...
  test.skip('should display completed bridge transfers in history', async ({
    page: _page,
  }) => {
    ...
    console.log(
      '⚠️  Bridge history display - requires completed bridge transaction',
    )
    console.log(
      '   Implementation: BridgeHistory component currently returns empty array',
    )
    console.log(
      '   To implement: Query Subsquid indexer or track events locally',
    )
  })

  test.skip('should show status indicators for transfers', async ({
    page: _page,
  }) => {
  ...
  test.skip('should link to block explorer for transactions', async ({
    page: _page,
  }) => {
  ...
  test.skip('should show timestamp for each transfer', async ({
    page: _page,
  }) => {
...
test.describe('Bridge History - Filtering and Sorting', () => {
  test.skip('should filter history by token', async ({ page: _page }) => {
  ...
  test.skip('should sort history by date', async ({ page: _page }) => {
    // TODO: If sorting exists, test newest/oldest first

    console.log('⚠️  History sorting - check if implemented')
  })

  test.skip('should paginate long history', async ({ page: _page }) => {
...
test.describe('Bridge History - Real-Time Updates', () => {
  test.skip('should add new transfer to history after bridge completes', async ({
    page: _page,
    metamask: _metamask,
  }) => {
  ...
  test.skip('should update transfer status from pending to confirmed', async ({
    page: _page,
  }) => {
  ...
  test.skip('should show failed transfers in history', async ({
    page: _page,
  }) => {
