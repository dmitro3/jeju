...
test.describe('Bridge UI and Validation', () => {
  ...
  test('should validate amount before enabling bridge button', async ({
    page,
  }) => {
    // Select token
...
test.describe('Bridge Transaction Approval', () => {
  test('should approve CLANKER for bridge', async ({ page, metamask }) => {
    ...
    const hasSecondTx = await page
      .locator('text=/Bridge transaction submitted/i')
  ...
  test.skip('should execute bridge after approval', async ({
    page: _page,
    metamask: _metamask,
  }) => {
...
test.describe('Bridge Error Handling', () => {
  ...
  test('should handle bridge transaction rejection', async ({
    page,
    metamask,
  }) => {
    await page.locator('.input').first().click()
...
test.describe('Bridge History Display', () => {
  ...
  test.skip('should display completed bridge transfer in history', async ({
    page: _page,
  }) => {
