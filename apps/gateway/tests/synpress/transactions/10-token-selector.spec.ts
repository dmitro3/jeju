...
test.describe('Token Selector - Paymaster Deployment Context', () => {
  test('should show all 4 tokens in paymaster selector', async ({
    page,
    metamask,
  }) => {
...
test.describe('Token Selector - Liquidity Context', () => {
  test('should show all 4 tokens in liquidity selector with balances', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
  ...
  test('should update selector when tokens selected', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Token Selector - Node Staking Context', () => {
  test('should show all tokens in both staking and reward selectors', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
  ...
  test('should allow selecting different token for rewards vs staking', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Token Selector - Bridge Context (Filtering)', () => {
  test('should ONLY show bridgeable tokens (exclude elizaOS)', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Token Selector - App Registry Context', () => {
  test('should show all tokens in registry stake selector', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
  ...
  test('should update required stake when token changes', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
    ...
    for (const token of tokensToTest) {
      ...
      if (await tokenOption.isVisible()) {
        ...
        const stakeDisplay = page
          .locator('p:has-text("Required Stake:")')
          .locator('..')
          .locator('p')
          .nth(1)
...
test.describe('Token Selector UI Interactions', () => {
  test('should open and close dropdown correctly', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
  ...
  test('should close dropdown when selecting token', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
  ...
  test.skip('should support keyboard navigation in dropdown', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
