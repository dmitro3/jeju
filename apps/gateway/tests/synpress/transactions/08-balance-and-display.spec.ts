...
test.describe('Balance Display Tests', () => {
  test('should display all 4 protocol token balances', async ({
    page,
    metamask,
  }) => {
...
test.describe('Balance Updates After Transactions', () => {
  test('should update balance after adding liquidity', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
    ...
    const ethBalanceBefore = await page
  ...
  test('should update token balance after claiming fees', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Token Approval Status', () => {
  test.skip('should display approval status for tokens', async ({
    page: _page,
  }) => {
  ...
  test.skip('should revoke token approvals', async ({
    page: _page,
    metamask: _metamask,
  }) => {
...
test.describe('Balance Precision and Formatting', () => {
  ...
  test('should display very small balances correctly', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('Real-Time Balance Updates', () => {
  test.skip('should update balance in real-time when transaction confirms', async ({
    page: _page,
    metamask: _metamask,
  }) => {
  ...
  test.skip('should show pending transaction indicator', async ({
    page: _page,
  }) => {
