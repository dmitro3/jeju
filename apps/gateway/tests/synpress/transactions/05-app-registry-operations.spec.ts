...
test.describe('App Registration Transactions', () => {
  ...
  test('should register app with elizaOS stake', async ({ page, metamask }) => {
    // Fill form
    await page
      .getByPlaceholder('My Awesome App')
      .fill(`${TEST_APP.name} elizaOS`)
  ...
  test('should register app with VIRTUAL stake', async ({ page, metamask }) => {
    await page
      .getByPlaceholder('My Awesome App')
      .fill(`${TEST_APP.name} VIRTUAL`)
    await page
      .getByPlaceholder(/Brief description/i)
      .fill('Testing with VIRTUAL stake')
  ...
  test('should register app with A2A endpoint', async ({ page, metamask }) => {
    ...
    await page
      .getByPlaceholder(/Brief description/i)
      .fill('App with A2A endpoint')
    await page
      .getByPlaceholder('https://myapp.com/a2a')
      .fill(TEST_APP.a2aEndpoint)
...
test.describe('App Stake Withdrawal Transactions', () => {
  test('should withdraw stake and de-register app', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('App Stake Approval and Registration', () => {
  test('should approve CLANKER before registering app', async ({
    page,
    metamask,
  }) => {
    await page.goto(GATEWAY_URL)
...
test.describe('App Edit and Update Transactions', () => {
  test.skip('should edit app metadata', async ({
    page: _page,
    metamask: _metamask,
  }) => {
  ...
  test.skip('should update A2A endpoint', async ({
    page: _page,
    metamask: _metamask,
  }) => {
