/**
 * Gateway Smoke Tests - Standalone Synpress (No shared fixtures)
 */
...
test.describe('Gateway Smoke Tests', () => {
  test('should connect to Gateway and verify all features', async ({
    page,
    metamask,
  }) => {
    // Navigate to Gateway
    ...
    // Verify all 4 protocol tokens load
