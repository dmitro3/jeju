/**
 * OAuth3 Provider for Gateway
 *
 * Wraps the app with OAuth3 authentication context.
 * This integrates with RainbowKit/wagmi for wallet connections
 * while adding OAuth3 for social auth, MFA, and verifiable credentials.
 */
