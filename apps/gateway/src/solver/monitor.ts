...
/** Event arguments from Open event */
...
/** Event log structure for parsing */
...
export class EventMonitor extends EventEmitter {
  ...
  /** Parse an event log into an IntentEvent. Protected for testing. */
  protected parseEvent(chainId: number, log: EventLog): IntentEvent | null {
