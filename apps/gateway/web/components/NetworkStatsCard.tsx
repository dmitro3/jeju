import { formatTokenUsd as formatUSD } from '@jejunetwork/shared'
import {
  AlertTriangle,
  Globe,
  type LucideProps,
            ...
            >
              ...
              <span
                style={{
                  fontSize: '0.875rem',
                  fontWeight: '600',
                  color: isNearLimit ? 'var(--warning)' : 'var(--success)',
                }}
              >
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      You're at {operatorOwnershipPercent.toFixed(1)}% of the
                      network. Limit is {maxOwnership}%. Adding more nodes may
                      be blocked.
                    </p>
                  </div>
                </div>
