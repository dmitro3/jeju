              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <ShieldIcon size={12} /> Tier
                    </span>
                    <span
                      style={{
                        fontWeight: 600,
                        color: `var(--${tier.className === 'text-muted' ? 'text-muted' : tier.className === 'text-success' ? 'success' : tier.className === 'text-info' ? 'info' : 'accent-primary'})`,
                      }}
                    >
                      {tier.label}
                      {app.stakeAmount !== '<0.001' &&
                        app.stakeAmount !== '0.000' && (
                          <span
                            style={{
                              fontWeight: 400,
                              color: 'var(--text-muted)',
