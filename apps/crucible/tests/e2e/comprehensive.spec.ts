...
const ROUTES = [
  { path: '/', name: 'Home', expectedContent: 'Crucible', description: 'Crucible home page with agent overview.' },
  { path: '/agents', name: 'Agents', expectedContent: 'Agent', description: 'List of AI agents.' },
  { path: '/agents/new', name: 'Create Agent', expectedContent: 'Create', description: 'Agent creation wizard.' },
  { path: '/chat', name: 'Chat', expectedContent: 'Chat', description: 'Chat interface with agents.' },
]
...
test.describe('Crucible - All Pages', () => {
