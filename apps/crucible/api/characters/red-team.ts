...
export const redTeamCharacter: AgentCharacter = {
  ...
  name: 'Phoenix',
  description:
    'Adversarial agent for security testing and finding vulnerabilities',
