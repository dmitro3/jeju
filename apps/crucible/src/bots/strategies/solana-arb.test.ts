...
describe('Solana Arbitrage Configuration', () => {
  ...
  describe('Solana Tokens', () => {
    it('should have SOL token defined', () => {
      ...
      expect(SOLANA_TOKENS.SOL.mint).toBe(
    ...
    it('should have USDC token defined', () => {
      ...
      expect(SOLANA_TOKENS.USDC.mint).toBe(
  ...
  describe('Bridge Costs', () => {
    ...
    it('should have bridge cost for Arbitrum', () => {
      ...
      expect(SOLANA_BRIDGE_COSTS[42161].costUsd).toBeLessThan(
        SOLANA_BRIDGE_COSTS[1].costUsd,
      )
    })

    it('should have bridge cost for Jeju', () => {
      expect(SOLANA_BRIDGE_COSTS[420691]).toBeDefined()
      expect(SOLANA_BRIDGE_COSTS[420691].costUsd).toBeLessThanOrEqual(
        SOLANA_BRIDGE_COSTS[42161].costUsd,
      )
    })

    it('Jeju should have fastest bridge time', () => {
      expect(SOLANA_BRIDGE_COSTS[420691].timeSec).toBeLessThan(
        SOLANA_BRIDGE_COSTS[1].timeSec,
      )
    })
  })
})
