...
describe('calculateSwapGas', () => {
  ...
  test('should calculate gas correctly for multi-hop swaps', () => {
    ...
    const expected = GAS_ESTIMATES.UNISWAP_V2_SWAP + 3n * GAS_ESTIMATES.PER_POOL_MARGIN;
...
describe('calculateArbitrageGas', () => {
  ...
  test('should calculate realistic gas for triangular arbitrage', () => {
    ...
    const expected = 3n * GAS_ESTIMATES.PER_POOL_MARGIN + 50000n + GAS_ESTIMATES.FLASH_LOAN_AAVE;
    expect(gas).toBe(expected);
...
describe('EIP-1559 Base Fee Prediction', () => {
  ...
  test('should predict base fee increase for full block', () => {
    ...
    const expectedNextFee = currentBaseFee + (currentBaseFee * BigInt(Math.floor(increasePercent * 100))) / 10000n;
  ...
  test('should predict base fee decrease for empty block', () => {
    ...
    const expectedNextFee = currentBaseFee - (currentBaseFee * BigInt(Math.floor(decreasePercent * 100))) / 10000n;
