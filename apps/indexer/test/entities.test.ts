...
function createAccountFactory() {
  ...
  return {
    getOrCreate(address: string, blockNumber: number, timestamp: Date): MockAccount {
      ...
      if (typeof blockNumber !== 'number' || blockNumber < 0 || !Number.isInteger(blockNumber)) {
        throw new Error(`Invalid blockNumber: ${blockNumber}. Must be a non-negative integer.`);
      }
...
describe('Account Factory', () => {
  ...
  describe('getOrCreate', () => {
    ...
    describe('retrieving existing accounts', () => {
      it('should return same instance for same address', () => {
        ...
        const account1 = factory.getOrCreate(address, 1000, new Date('2024-01-01'));
        const account2 = factory.getOrCreate(address, 2000, new Date('2024-06-01'));
      ...
      it('should update lastSeenBlock on subsequent access', () => {
        ...
        const account = factory.getOrCreate(address, 5000, new Date('2024-06-01'));
      ...
      it('should be case-insensitive for address matching', () => {
        ...
        const account1 = factory.getOrCreate(lower, 1000, new Date('2024-01-01'));
        const account2 = factory.getOrCreate(upper, 2000, new Date('2024-06-01'));
    ...
    describe('input validation', () => {
      it('should throw on empty address', () => {
        expect(() => factory.getOrCreate('', 1, new Date())).toThrow('address is required');
      });
      ...
      it('should throw on null address', () => {
        expect(() => factory.getOrCreate(null as unknown as string, 1, new Date())).toThrow('address is required');
      });

      it('should throw on undefined address', () => {
        expect(() => factory.getOrCreate(undefined as unknown as string, 1, new Date())).toThrow('address is required');
      });

      it('should throw on negative block number', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', -1, new Date()))
          .toThrow('Invalid blockNumber');
      });

      it('should throw on non-integer block number', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', 1.5, new Date()))
          .toThrow('Invalid blockNumber');
      });

      it('should throw on NaN block number', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', NaN, new Date()))
          .toThrow('Invalid blockNumber');
      });

      it('should throw on string block number', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', '100' as unknown as number, new Date()))
          .toThrow('Invalid blockNumber');
      });

      it('should throw on invalid date', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', 1, new Date('invalid')))
          .toThrow('timestamp must be a valid Date object');
      });

      it('should throw on non-date timestamp', () => {
        expect(() => factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', 1, '2024-01-01' as unknown as Date))
          .toThrow('timestamp must be a valid Date object');
      });

      it('should accept block number 0 (genesis)', () => {
        const account = factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', 0, new Date());
  ...
  describe('getAll', () => {
    ...
    it('should return all created accounts', () => {
      factory.getOrCreate('0x1111111111111111111111111111111111111111', 1, new Date());
      factory.getOrCreate('0x2222222222222222222222222222222222222222', 2, new Date());
      factory.getOrCreate('0x3333333333333333333333333333333333333333', 3, new Date());
    ...
    it('should not include duplicates from same address', () => {
      factory.getOrCreate('0x1111111111111111111111111111111111111111', 1, new Date());
      factory.getOrCreate('0x1111111111111111111111111111111111111111', 2, new Date());
      factory.getOrCreate('0x1111111111111111111111111111111111111111', 3, new Date());
  ...
  describe('getMap', () => {
    ...
    it('should allow direct access for advanced operations', () => {
      const account = factory.getOrCreate('0x1111111111111111111111111111111111111111', 1, new Date());
  ...
  describe('factory isolation', () => {
    it('should not share state between factory instances', () => {
      ...
      factory1.getOrCreate('0x1111111111111111111111111111111111111111', 1, new Date());
    ...
    it('should create independent accounts in different factories', () => {
      ...
      const account1 = factory1.getOrCreate(address, 1000, new Date('2024-01-01'));
      const account2 = factory2.getOrCreate(address, 2000, new Date('2024-06-01'));
...
describe('Account Entity State Tracking', () => {
  ...
  it('should allow modification of account properties after creation', () => {
    const factory = createAccountFactory();
    const account = factory.getOrCreate('0x1234567890abcdef1234567890abcdef12345678', 1, new Date());
...
describe('Block Header and Log Data Interfaces', () => {
  ...
  it('should comply with LogData interface', () => {
    const log: LogData = {
      ...
      logIndex: 5,
      transactionIndex: 10,
      transaction: { hash: '0xdeadbeef1234567890abcdef1234567890abcdef1234567890abcdef12345678' },
    };
