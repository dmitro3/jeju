import {Entity as Entity_, Column as Column_, PrimaryColumn as PrimaryColumn_, StringColumn as StringColumn_, Index as Index_, IntColumn as IntColumn_, ManyToOne as ManyToOne_, BigIntColumn as BigIntColumn_, BooleanColumn as BooleanColumn_, DateTimeColumn as DateTimeColumn_, OneToMany as OneToMany_} from "@subsquid/typeorm-store"
...
export class DEXPool {
    ...
    @OneToMany_(() => PoolHourlyCandle, e => e.pool)
    hourlyCandles!: PoolHourlyCandle[]

    @OneToMany_(() => PoolDailyCandle, e => e.pool)
