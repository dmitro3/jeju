import {Entity as Entity_, Column as Column_, PrimaryColumn as PrimaryColumn_, StringColumn as StringColumn_, Index as Index_, IntColumn as IntColumn_, BigIntColumn as BigIntColumn_, DateTimeColumn as DateTimeColumn_, BooleanColumn as BooleanColumn_, ManyToOne as ManyToOne_, OneToMany as OneToMany_} from "@subsquid/typeorm-store"
...
export class Token {
    ...
    @OneToMany_(() => DEXPool, e => e.token0)
    pools0!: DEXPool[]

    @OneToMany_(() => DEXPool, e => e.token1)
    pools1!: DEXPool[]

    @OneToMany_(() => Swap, e => e.tokenIn)
    swapsIn!: Swap[]

    @OneToMany_(() => Swap, e => e.tokenOut)
    swapsOut!: Swap[]

    @OneToMany_(() => TokenCandle, e => e.token)
    candles!: TokenCandle[]
}
