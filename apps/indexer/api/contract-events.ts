...
export const ERC721_APPROVAL_FOR_ALL = eventSig(
  'ApprovalForAll(address,address,bool)',
)
export const ERC1155_TRANSFER_SINGLE = eventSig(
...
export const FEES_DISTRIBUTED = eventSig(
  'FeesDistributed(address,uint256,uint256,uint256,uint256,uint256)',
)
...
export const SERVICE_USAGE_RECORDED = eventSig(
  'ServiceUsageRecorded(address,string,uint256,bytes32,uint256)',
)
export const CREDIT_DEPOSITED = eventSig(
  'CreditDeposited(address,address,uint256,uint256)',
)
export const CREDIT_DEDUCTED = eventSig(
  'CreditDeducted(address,address,address,uint256,uint256)',
)
...
export const GOLD_SIGNER_UPDATED = eventSig(
  'GameSignerUpdated(address,address)',
)
export const ITEM_MINTED = eventSig(
  'ItemMinted(address,uint256,uint256,bytes32,bool,uint8)',
)
export const ITEM_BURNED = eventSig('ItemBurned(address,uint256,uint256)')
export const ITEM_TYPE_CREATED = eventSig(
  'ItemTypeCreated(uint256,string,bool,uint8)',
)
export const NFT_PROVENANCE = eventSig(
...
export const LISTING_SOLD = eventSig(
  'ListingSold(uint256,address,address,uint256,uint8)',
)
...
export const SHARES_PURCHASED = eventSig(
  'SharesPurchased(bytes32,address,bool,uint256,uint256,address)',
)
export const SHARES_SOLD = eventSig(
  'SharesSold(bytes32,address,bool,uint256,uint256,address)',
)
...
export const GAME_COMMITTED = eventSig(
  'GameCommitted(bytes32,string,bytes32,uint256)',
)
...
export const MARKET_UPDATED = eventSig(
  'MarketUpdated(bytes32,uint8,uint8,uint256,uint8,uint256)',
)
export const SKILL_LEVEL_UP = eventSig(
  'SkillLevelUp(address,string,uint8,uint256,uint256)',
)
export const PLAYER_DEATH = eventSig(
  'PlayerDeath(address,address,string,uint256)',
)
export const PLAYER_KILL = eventSig(
  'PlayerKill(address,address,string,uint256)',
)
export const PLAYER_ACHIEVEMENT = eventSig(
  'PlayerAchievement(address,bytes32,string,uint256,uint256)',
)
export const PREDICTION_CREATED = eventSig(
  'PredictionCreated(bytes32,string,address,uint256,bytes32)',
)
export const PREDICTION_RESOLVED = eventSig(
...
export const STAKE_INCREASED = eventSig(
  'StakeIncreased(uint256,uint8,uint8,uint256)',
)
export const STAKE_WITHDRAWN = eventSig(
  'StakeWithdrawn(uint256,address,uint256)',
)
...
export const REPUTATION_ORACLE_UPDATED = eventSig(
  'ReputationOracleUpdated(address,address)',
)
...
export const APP_BAN_APPLIED = eventSig(
  'AppBanApplied(uint256,bytes32,string,bytes32,uint256)',
)
export const NETWORK_BAN_REMOVED = eventSig(
  'NetworkBanRemoved(uint256,uint256)',
)
...
export const REPORT_EXECUTED = eventSig(
  'ReportExecuted(uint256,uint256,uint8,uint256)',
)
export const REPORTER_REWARDED = eventSig(
  'ReporterRewarded(uint256,address,uint256)',
)
export const REPORTER_SLASHED = eventSig(
  'ReporterSlashed(uint256,address,uint256)',
)
export const CRITICAL_TEMP_BAN = eventSig(
...
export const PERFORMANCE_UPDATED = eventSig(
  'PerformanceUpdated(bytes32,uint256,uint256,uint256)',
)
export const REWARDS_CLAIMED = eventSig(
  'RewardsClaimed(bytes32,address,address,uint256,uint256)',
)
export const NODE_SLASHED = eventSig(
  'NodeSlashed(bytes32,address,uint256,string)',
)
...
export const PROVIDER_UPDATED = eventSig(
  'ProviderUpdated(address,string,bytes32)',
)
...
export const STAKE_WITHDRAWN_COMPUTE = eventSig(
  'StakeWithdrawn(address,uint256)',
)
export const CAPABILITY_ADDED = eventSig(
  'CapabilityAdded(address,string,uint256,uint256,uint256)',
)
...
export const RENTAL_STARTED = eventSig(
  'RentalStarted(bytes32,string,uint16,string)',
)
export const RENTAL_COMPLETED = eventSig(
  'RentalCompleted(bytes32,uint256,uint256)',
)
export const RENTAL_CANCELLED = eventSig('RentalCancelled(bytes32,uint256)')
export const RENTAL_EXTENDED = eventSig(
  'RentalExtended(bytes32,uint256,uint256)',
)
export const RENTAL_RATED = eventSig(
  'RentalRated(bytes32,address,uint8,string)',
)
export const DISPUTE_CREATED = eventSig(
  'DisputeCreated(bytes32,bytes32,address,uint8,string)',
)
export const DISPUTE_RESOLVED = eventSig(
  'DisputeResolved(bytes32,bool,uint256)',
)
...
export const SERVICE_DEACTIVATED = eventSig(
  'ServiceDeactivated(address,uint256)',
)
export const SETTLED = eventSig(
  'Settled(address,address,bytes32,uint256,uint256,uint256,uint256)',
)
export const AGENT_SETTLED = eventSig(
...
export const ORDER_SETTLED = eventSig(
  'OrderSettled(bytes32,address,uint256,uint256)',
)
...
export const LIQUIDITY_DEPOSITED = eventSig(
  'LiquidityDeposited(address,address,uint256)',
)
export const LIQUIDITY_WITHDRAWN = eventSig(
  'LiquidityWithdrawn(address,address,uint256)',
)
export const ORDER_FILLED = eventSig(
  'OrderFilled(bytes32,address,address,address,uint256)',
)

export const SOLVER_REGISTERED = eventSig(
  'SolverRegistered(address,uint256,uint256[])',
)
export const SOLVER_STAKE_DEPOSITED = eventSig(
  'SolverStakeDeposited(address,uint256,uint256)',
)
...
export const ATTESTATION_SUBMITTED = eventSig(
...
export const VOUCHER_REQUESTED = eventSig(
  'VoucherRequested(bytes32,address,address,uint256,uint256,address)',
)
export const VOUCHER_ISSUED = eventSig(
  'VoucherIssued(bytes32,address,uint256,address)',
)
export const VOUCHER_FULFILLED = eventSig(
  'VoucherFulfilled(bytes32,address,uint256)',
)
export const VOUCHER_EXPIRED = eventSig(
  'VoucherExpired(bytes32,address,uint256)',
)
export const FUNDS_REFUNDED = eventSig('FundsRefunded(bytes32,address,uint256)')
export const XLP_DEPOSIT = eventSig(
  'XLPDeposit(address,address,uint256,uint256)',
)
export const XLP_WITHDRAW = eventSig(
  'XLPWithdraw(address,address,uint256,uint256)',
)
export const SOURCE_FUNDS_CLAIMED = eventSig(
  'SourceFundsClaimed(bytes32,address,uint256)',
)
export const TOKEN_SUPPORT_UPDATED = eventSig(
  'TokenSupportUpdated(address,bool)',
)

export const XLP_REGISTERED = eventSig(
  'XLPRegistered(address,uint256,uint256[])',
)
export const STAKE_DEPOSITED = eventSig(
  'StakeDeposited(address,uint256,uint256)',
)
export const UNBONDING_STARTED = eventSig(
  'UnbondingStarted(address,uint256,uint256)',
)
export const XLP_SLASHED = eventSig(
  'XLPSlashed(address,bytes32,uint256,address)',
)
export const SLASH_DISPUTED = eventSig('SlashDisputed(bytes32,address)')
export const L2_PAYMASTER_REGISTERED = eventSig(
  'L2PaymasterRegistered(uint256,address)',
)
export const AUTHORIZED_SLASHER_UPDATED = eventSig(
  'AuthorizedSlasherUpdated(address,bool)',
)
...
export const OTC_LISTING_FILLED = eventSig(
  'ListingFilled(uint256,address,uint256)',
)
export const OTC_LISTING_CANCELLED = eventSig('ListingCancelled(uint256)')
export const OTC_LISTING_UPDATED = eventSig(
  'ListingUpdated(uint256,uint256,uint256)',
)
export const OTC_SWAP_EXECUTED = eventSig(
...
export const TOKEN_REGISTERED = eventSig(
  'TokenRegistered(address,address,string,string,address,uint256,uint256,uint256)',
)
...
export const EVENT_REGISTRY: Record<string, EventCategory> = {
  [ERC20_TRANSFER]: {
    signature: ERC20_TRANSFER,
    name: 'Transfer',
    category: 'token',
    contract: 'ERC20',
  },
  [ERC20_APPROVAL]: {
    signature: ERC20_APPROVAL,
    name: 'Approval',
    category: 'token',
    contract: 'ERC20',
  },
  [ERC1155_TRANSFER_SINGLE]: {
    signature: ERC1155_TRANSFER_SINGLE,
    name: 'TransferSingle',
    category: 'token',
    contract: 'ERC1155',
  },
  [TRANSACTION_SPONSORED]: {
    signature: TRANSACTION_SPONSORED,
    name: 'TransactionSponsored',
    category: 'paymaster',
    contract: 'LiquidityPaymaster',
  },
  [FEES_DISTRIBUTED]: {
    signature: FEES_DISTRIBUTED,
  ...
  [ETH_REMOVED]: {
    signature: ETH_REMOVED,
    name: 'ETHRemoved',
    category: 'paymaster',
    contract: 'LiquidityVault',
  },
  [FEES_CLAIMED]: {
    signature: FEES_CLAIMED,
    name: 'FeesClaimed',
    category: 'paymaster',
    contract: 'LiquidityVault',
  },
  [SERVICE_REGISTERED]: {
    signature: SERVICE_REGISTERED,
    name: 'ServiceRegistered',
    category: 'cloud',
    contract: 'ServiceRegistry',
  },
  [SERVICE_USAGE_RECORDED]: {
    signature: SERVICE_USAGE_RECORDED,
    name: 'ServiceUsageRecorded',
    category: 'cloud',
    contract: 'ServiceRegistry',
  },
  [CREDIT_DEPOSITED]: {
    signature: CREDIT_DEPOSITED,
    name: 'CreditDeposited',
    category: 'cloud',
    contract: 'CreditManager',
  },
  [CREDITS_PURCHASED]: {
    signature: CREDITS_PURCHASED,
    name: 'CreditsPurchased',
    category: 'cloud',
    contract: 'CreditPurchaseContract',
  },
  [PLAYER_REGISTERED]: {
    signature: PLAYER_REGISTERED,
    name: 'PlayerRegistered',
    category: 'game',
    contract: 'GameContract',
  },
  [PLAYER_MOVED]: {
    signature: PLAYER_MOVED,
    name: 'PlayerMoved',
    category: 'game',
    contract: 'GameContract',
  },
  [PLAYER_DIED]: {
    signature: PLAYER_DIED,
    name: 'PlayerDied',
    category: 'game',
    contract: 'GameContract',
  },
  ...
  [MOB_KILLED]: {
    signature: MOB_KILLED,
    name: 'MobKilled',
    category: 'game',
    contract: 'GameContract',
  },
  [GOLD_CLAIMED]: {
    signature: GOLD_CLAIMED,
    name: 'GoldClaimed',
    category: 'game',
    contract: 'Gold',
  },
  [GOLD_BURNED]: {
    signature: GOLD_BURNED,
    name: 'GoldBurned',
    category: 'game',
    contract: 'Gold',
  },
  [GOLD_SIGNER_UPDATED]: {
    signature: GOLD_SIGNER_UPDATED,
    name: 'GameSignerUpdated',
    category: 'game',
    contract: 'Gold',
  },
  [ITEM_MINTED]: {
    signature: ITEM_MINTED,
    name: 'ItemMinted',
    category: 'game',
    contract: 'Items',
  },
  [ITEM_BURNED]: {
    signature: ITEM_BURNED,
    name: 'ItemBurned',
    category: 'game',
    contract: 'Items',
  },
  [ITEM_TYPE_CREATED]: {
    signature: ITEM_TYPE_CREATED,
    name: 'ItemTypeCreated',
    category: 'game',
    contract: 'Items',
  },
  [NFT_PROVENANCE]: {
    signature: NFT_PROVENANCE,
    name: 'NFTProvenance',
    category: 'game',
    contract: 'Items',
  },
  [LISTING_CREATED]: {
    signature: LISTING_CREATED,
    name: 'ListingCreated',
    category: 'marketplace',
    contract: 'Bazaar',
  },
  [LISTING_SOLD]: {
    signature: LISTING_SOLD,
    name: 'ListingSold',
    category: 'marketplace',
    contract: 'Bazaar',
  },
  [TRADE_EXECUTED]: {
    signature: TRADE_EXECUTED,
    name: 'TradeExecuted',
    category: 'marketplace',
    contract: 'PlayerTradeEscrow',
  },
  [MARKET_CREATED]: {
  ...
  [GAME_REVEALED]: {
    signature: GAME_REVEALED,
    name: 'GameRevealed',
    category: 'prediction',
    contract: 'PredictionOracle',
  },
  [FEED_POST_PUBLISHED]: {
    signature: FEED_POST_PUBLISHED,
    name: 'FeedPostPublished',
    category: 'oracle',
    contract: 'GameFeedOracle',
  },
  [MARKET_UPDATED]: {
    signature: MARKET_UPDATED,
    name: 'MarketUpdated',
    category: 'oracle',
    contract: 'GameFeedOracle',
  },
  [SKILL_LEVEL_UP]: {
    signature: SKILL_LEVEL_UP,
    name: 'SkillLevelUp',
    category: 'oracle',
    contract: 'GameOracle',
  },
  [PRICES_UPDATED]: {
    signature: PRICES_UPDATED,
    name: 'PricesUpdated',
    category: 'oracle',
    contract: 'ManualPriceOracle',
  },
  [AGENT_REGISTERED]: {
    signature: AGENT_REGISTERED,
    name: 'Registered',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [STAKE_INCREASED]: {
    signature: STAKE_INCREASED,
    name: 'StakeIncreased',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [STAKE_WITHDRAWN]: {
    signature: STAKE_WITHDRAWN,
    name: 'StakeWithdrawn',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [AGENT_BANNED]: {
    signature: AGENT_BANNED,
    name: 'AgentBanned',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [AGENT_UNBANNED]: {
    signature: AGENT_UNBANNED,
    name: 'AgentUnbanned',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [AGENT_SLASHED]: {
    signature: AGENT_SLASHED,
    name: 'AgentSlashed',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [TAGS_UPDATED]: {
    signature: TAGS_UPDATED,
    name: 'TagsUpdated',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [AGENT_URI_UPDATED]: {
    signature: AGENT_URI_UPDATED,
    name: 'AgentUriUpdated',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [METADATA_SET]: {
    signature: METADATA_SET,
    name: 'MetadataSet',
    category: 'registry',
    contract: 'IdentityRegistry',
  },
  [NEW_FEEDBACK]: {
    signature: NEW_FEEDBACK,
    name: 'NewFeedback',
    category: 'registry',
    contract: 'ReputationRegistry',
  },
  [FEEDBACK_REVOKED]: {
    signature: FEEDBACK_REVOKED,
    name: 'FeedbackRevoked',
    category: 'registry',
    contract: 'ReputationRegistry',
  },
  [RESPONSE_APPENDED]: {
    signature: RESPONSE_APPENDED,
    name: 'ResponseAppended',
    category: 'registry',
    contract: 'ReputationRegistry',
  },
  [VALIDATION_REQUEST]: {
    signature: VALIDATION_REQUEST,
    name: 'ValidationRequest',
    category: 'registry',
    contract: 'ValidationRegistry',
  },
  [VALIDATION_RESPONSE]: {
    signature: VALIDATION_RESPONSE,
  ...
  // Moderation events
  [NETWORK_BAN_APPLIED]: {
    signature: NETWORK_BAN_APPLIED,
    name: 'NetworkBanApplied',
    category: 'moderation',
    contract: 'BanManager',
  },
  [APP_BAN_APPLIED]: {
    signature: APP_BAN_APPLIED,
    name: 'AppBanApplied',
    category: 'moderation',
    contract: 'BanManager',
  },
  [NETWORK_BAN_REMOVED]: {
    signature: NETWORK_BAN_REMOVED,
    name: 'NetworkBanRemoved',
    category: 'moderation',
    contract: 'BanManager',
  },
  [APP_BAN_REMOVED]: {
    signature: APP_BAN_REMOVED,
    name: 'AppBanRemoved',
    category: 'moderation',
    contract: 'BanManager',
  },
  [REPORT_CREATED]: {
    signature: REPORT_CREATED,
    name: 'ReportCreated',
    category: 'moderation',
    contract: 'ReportingSystem',
  },
  [REPORT_RESOLVED]: {
    signature: REPORT_RESOLVED,
    name: 'ReportResolved',
    category: 'moderation',
    contract: 'ReportingSystem',
  },
  [CRITICAL_TEMP_BAN]: {
    signature: CRITICAL_TEMP_BAN,
    name: 'CriticalTempBan',
    category: 'moderation',
    contract: 'ReportingSystem',
  },
  ...
  // Node staking events
  [NODE_REGISTERED]: {
    signature: NODE_REGISTERED,
    name: 'NodeRegistered',
    category: 'node',
    contract: 'NodeStakingManager',
  },
  [NODE_DEREGISTERED]: {
    signature: NODE_DEREGISTERED,
    name: 'NodeDeregistered',
    category: 'node',
    contract: 'NodeStakingManager',
  },
  [PERFORMANCE_UPDATED]: {
    signature: PERFORMANCE_UPDATED,
    name: 'PerformanceUpdated',
    category: 'node',
    contract: 'NodeStakingManager',
  },
  [REWARDS_CLAIMED]: {
    signature: REWARDS_CLAIMED,
    name: 'RewardsClaimed',
    category: 'node',
    contract: 'NodeStakingManager',
  },
  [NODE_SLASHED]: {
    signature: NODE_SLASHED,
    name: 'NodeSlashed',
    category: 'node',
    contract: 'NodeStakingManager',
  },
  ...
  // Compute events
  [PROVIDER_REGISTERED]: {
    signature: PROVIDER_REGISTERED,
    name: 'ProviderRegistered',
    category: 'compute',
    contract: 'ComputeRegistry',
  },
  [PROVIDER_UPDATED]: {
    signature: PROVIDER_UPDATED,
    name: 'ProviderUpdated',
    category: 'compute',
    contract: 'ComputeRegistry',
  },
  [PROVIDER_DEACTIVATED]: {
    signature: PROVIDER_DEACTIVATED,
    name: 'ProviderDeactivated',
    category: 'compute',
    contract: 'ComputeRegistry',
  },
  [PROVIDER_REACTIVATED]: {
    signature: PROVIDER_REACTIVATED,
    name: 'ProviderReactivated',
    category: 'compute',
    contract: 'ComputeRegistry',
  },
  [CAPABILITY_ADDED]: {
    signature: CAPABILITY_ADDED,
    name: 'CapabilityAdded',
    category: 'compute',
    contract: 'ComputeRegistry',
  },
  [RENTAL_CREATED]: {
    signature: RENTAL_CREATED,
    name: 'RentalCreated',
    category: 'compute',
    contract: 'ComputeRental',
  },
  [RENTAL_STARTED]: {
    signature: RENTAL_STARTED,
    name: 'RentalStarted',
    category: 'compute',
    contract: 'ComputeRental',
  },
  [RENTAL_COMPLETED]: {
    signature: RENTAL_COMPLETED,
    name: 'RentalCompleted',
    category: 'compute',
    contract: 'ComputeRental',
  },
  [RENTAL_CANCELLED]: {
    signature: RENTAL_CANCELLED,
  ...
  // OIF events
  [ORDER_CREATED]: {
    signature: ORDER_CREATED,
    name: 'OrderCreated',
    category: 'oif',
    contract: 'InputSettler',
  },
  [ORDER_CLAIMED]: {
    signature: ORDER_CLAIMED,
    name: 'OrderClaimed',
    category: 'oif',
    contract: 'InputSettler',
  },
  [ORDER_SETTLED]: {
    signature: ORDER_SETTLED,
    name: 'OrderSettled',
    category: 'oif',
    contract: 'InputSettler',
  },
  [ORDER_REFUNDED]: {
    signature: ORDER_REFUNDED,
    name: 'OrderRefunded',
    category: 'oif',
    contract: 'InputSettler',
  },
  [ORDER_FILLED]: {
    signature: ORDER_FILLED,
    name: 'OrderFilled',
    category: 'oif',
    contract: 'OutputSettler',
  },
  [LIQUIDITY_DEPOSITED]: {
    signature: LIQUIDITY_DEPOSITED,
    name: 'LiquidityDeposited',
    category: 'oif',
    contract: 'OutputSettler',
  },
  [LIQUIDITY_WITHDRAWN]: {
    signature: LIQUIDITY_WITHDRAWN,
    name: 'LiquidityWithdrawn',
    category: 'oif',
    contract: 'OutputSettler',
  },
  [SOLVER_REGISTERED]: {
    signature: SOLVER_REGISTERED,
    name: 'SolverRegistered',
    category: 'oif',
    contract: 'SolverRegistry',
  },
  [SOLVER_SLASHED]: {
    signature: SOLVER_SLASHED,
    name: 'SolverSlashed',
    category: 'oif',
    contract: 'SolverRegistry',
  },
  [ATTESTATION_SUBMITTED]: {
    signature: ATTESTATION_SUBMITTED,
    name: 'AttestationSubmitted',
    category: 'oif',
    contract: 'HyperlaneOracle',
  },

  // EIL events
  [VOUCHER_REQUESTED]: {
    signature: VOUCHER_REQUESTED,
    name: 'VoucherRequested',
    category: 'eil',
    contract: 'EILVault',
  },
  [VOUCHER_ISSUED]: {
    signature: VOUCHER_ISSUED,
    name: 'VoucherIssued',
    category: 'eil',
    contract: 'EILVault',
  },
  [VOUCHER_FULFILLED]: {
    signature: VOUCHER_FULFILLED,
    name: 'VoucherFulfilled',
    category: 'eil',
    contract: 'EILVault',
  },
  [XLP_REGISTERED]: {
    signature: XLP_REGISTERED,
    name: 'XLPRegistered',
    category: 'eil',
    contract: 'EILRegistry',
  },
  [XLP_SLASHED]: {
    signature: XLP_SLASHED,
    name: 'XLPSlashed',
    category: 'eil',
    contract: 'EILRegistry',
  },
  ...
  // OTC events
  [OTC_LISTING_CREATED]: {
    signature: OTC_LISTING_CREATED,
    name: 'ListingCreated',
    category: 'defi',
    contract: 'OTC',
  },
  [OTC_LISTING_FILLED]: {
    signature: OTC_LISTING_FILLED,
    name: 'ListingFilled',
    category: 'defi',
    contract: 'OTC',
  },
  [OTC_SWAP_EXECUTED]: {
    signature: OTC_SWAP_EXECUTED,
    name: 'SwapExecuted',
    category: 'defi',
    contract: 'OTC',
  },
  ...
  // Factory events
  [PAYMASTER_DEPLOYED]: {
    signature: PAYMASTER_DEPLOYED,
    name: 'PaymasterDeployed',
    category: 'paymaster',
    contract: 'PaymasterFactory',
  },
  [TOKEN_REGISTERED]: {
    signature: TOKEN_REGISTERED,
    name: 'TokenRegistered',
    category: 'paymaster',
    contract: 'TokenRegistry',
  },
  [TOKEN_CREATED]: {
    signature: TOKEN_CREATED,
    name: 'TokenCreated',
    category: 'token',
  ...
  // JEJU Token events
  [BAN_ENFORCEMENT_TOGGLED]: {
    signature: BAN_ENFORCEMENT_TOGGLED,
    name: 'BanEnforcementToggled',
    category: 'token',
    contract: 'NetworkToken',
  },
  [BAN_MANAGER_UPDATED]: {
    signature: BAN_MANAGER_UPDATED,
    name: 'BanManagerUpdated',
    category: 'token',
    contract: 'NetworkToken',
  },
  [FAUCET_CLAIMED]: {
    signature: FAUCET_CLAIMED,
    name: 'FaucetClaimed',
    category: 'token',
    contract: 'NetworkToken',
  },
  [FAUCET_TOGGLED]: {
    signature: FAUCET_TOGGLED,
    name: 'FaucetToggled',
    category: 'token',
    contract: 'NetworkToken',
  },
...
export const EIL_EVENTS = [
  ...
  XLP_DEPOSIT,
  XLP_WITHDRAW,
  SOURCE_FUNDS_CLAIMED,
  TOKEN_SUPPORT_UPDATED,
  XLP_REGISTERED,
  STAKE_DEPOSITED,
  UNBONDING_STARTED,
  XLP_SLASHED,
  SLASH_DISPUTED,
  L2_PAYMASTER_REGISTERED,
  AUTHORIZED_SLASHER_UPDATED,
  CHAIN_REGISTERED,
  CHAIN_UNREGISTERED,
]
