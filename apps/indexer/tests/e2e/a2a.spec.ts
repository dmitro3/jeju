...
test.describe('A2A Agent Card', () => {
  test('should return agent card at well-known endpoint', async ({
    request,
  }) => {
    const response = await request.get(
      `${A2A_BASE_URL}/.well-known/agent-card.json`,
    )
    ...
    expect(agentCard.name).toBe('Indexer')
  ...
  test('should have query-blocks skill', async ({ request }) => {
    ...
    const blockSkill = agentCard.skills.find(
      (s: { id: string }) => s.id === 'query-blocks',
    )
  ...
  test('should have query-transactions skill', async ({ request }) => {
    ...
    const txSkill = agentCard.skills.find(
      (s: { id: string }) => s.id === 'query-transactions',
    )
  ...
  test('should have query-tokens skill', async ({ request }) => {
    ...
    const tokenSkill = agentCard.skills.find(
      (s: { id: string }) => s.id === 'query-tokens',
    )
  ...
  test('should have custom-query skill (premium)', async ({ request }) => {
    ...
    const customSkill = agentCard.skills.find(
      (s: { id: string }) => s.id === 'custom-query',
    )
...
test.describe('A2A Message API', () => {
  ...
  test('should handle message/send with query-blocks skill', async ({
    request,
  }) => {
    const response = await request.post(`${A2A_BASE_URL}/api/a2a`, {
      data: {
        ...
        params: {
          message: {
            messageId: 'test-1',
            parts: [{ kind: 'data', data: { skillId: 'query-blocks' } }],
          },
        },
        id: 1,
      },
  ...
  test('should handle message/send with query-transactions skill', async ({
    request,
  }) => {
    const response = await request.post(`${A2A_BASE_URL}/api/a2a`, {
      data: {
        ...
        params: {
          message: {
            messageId: 'test-2',
            parts: [{ kind: 'data', data: { skillId: 'query-transactions' } }],
          },
        },
        id: 2,
      },
  ...
  test('should handle message/send with query-tokens skill', async ({
    request,
  }) => {
    const response = await request.post(`${A2A_BASE_URL}/api/a2a`, {
      data: {
        ...
        params: {
          message: {
            messageId: 'test-3',
            parts: [{ kind: 'data', data: { skillId: 'query-tokens' } }],
          },
        },
        id: 3,
      },
    ...
    const response = await request.post(`${A2A_BASE_URL}/api/a2a`, {
      data: {
        ...
        params: {
          message: {
            messageId: 'test-4',
            parts: [{ kind: 'data', data: { skillId: 'custom-query' } }],
          },
        },
        id: 4,
      },
