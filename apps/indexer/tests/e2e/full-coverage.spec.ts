/**
 * Network Indexer Full E2E Coverage Tests
 *
...
const BASE_URL = process.env.INDEXER_URL || 'http://localhost:4355'

test.describe('Network Indexer - Full Coverage', () => {
...
test.describe('Network Indexer - Navigation', () => {
...
test.describe('Network Indexer - Button Interactions', () => {
...
test.describe('Network Indexer - Form Interactions', () => {
...
test.describe('Network Indexer - Error States', () => {
