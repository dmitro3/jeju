...
// Mock storage
mock.module('../../../web/platform/storage', () => ({
  storage: {
...
describe('ContactsService', () => {
  ...
  describe('addContact', () => {
    it('should add a new contact', async () => {
      ...
      // getAddress returns checksummed address (EIP-55)
    ...
    it('should normalize address to checksummed format', async () => {
      const contact = await contactsService.addContact({
  ...
  describe('recordTransaction', () => {
    it('should increment transaction count', async () => {
      ...
      await contactsService.recordTransaction(
        '0x1234567890abcdef1234567890abcdef12345678',
      )
  ...
  describe('getAddressLabel', () => {
    it('should return contact name if exists', async () => {
      ...
      const label = contactsService.getAddressLabel(
        '0x1234567890abcdef1234567890abcdef12345678',
      )
