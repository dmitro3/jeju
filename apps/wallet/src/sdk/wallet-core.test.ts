...
describe('WalletCore', () => {
  ...
  describe('Account Management', () => {
    ...
    it('should switch active account', async () => {
      const account1 = await wallet.addAccount({ type: 'eoa', label: 'Account 1' });
      const account2 = await wallet.addAccount({ type: 'eoa', label: 'Account 2' });
  ...
  describe('Chain Management', () => {
    ...
    it('should throw for unsupported chain', async () => {
      await expect(wallet.switchChain(999999))
  ...
  describe('EIP-1193 Provider Interface', () => {
    ...
    describe('unsupported methods', () => {
      it('should throw for unsupported method', async () => {
        await expect(wallet.request({ method: 'eth_unsupportedMethod' }))
  ...
  describe('Cross-Chain Clients', () => {
    describe('getEILClient', () => {
      ...
      it('should throw for unconfigured chain', () => {
        expect(() => wallet.getEILClient(999999))
          .toThrow('EIL not configured for chain 999999');
      });
    });
    ...
    describe('getOIFClient', () => {
      ...
      it('should throw for unconfigured chain', () => {
        expect(() => wallet.getOIFClient(999999))
          .toThrow('OIF not configured for chain 999999');
      });
    });
    ...
    describe('getAAClient', () => {
      ...
      it('should throw for unconfigured chain', () => {
        expect(() => wallet.getAAClient(999999))
          .toThrow('AA not configured for chain 999999');
      });
    });
  ...
  describe('Site Connections', () => {
    ...
    it('should throw on connect without account', async () => {
      await expect(wallet.connect('https://example.com'))
