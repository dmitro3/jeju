...
describe('HistoryService', () => {
  ...
  describe('formatTransaction', () => {
    ...
    it('should include transaction status', () => {
      ...
      expect(service.formatTransaction(pendingTx, userAddress).status).toBe(
        'pending',
      )
      expect(service.formatTransaction(confirmedTx, userAddress).status).toBe(
        'confirmed',
      )
      expect(service.formatTransaction(failedTx, userAddress).status).toBe(
        'failed',
      )
    })
