  ...
  examples: [
    [
      ...
      },
      {
        name: 'assistant',
        content: {
          text: "I'll help you send 0.1 ETH to that address.",
    ...
    [
      { name: 'user', content: { text: 'Transfer 100 USDC to alice.eth' } },
      {
        name: 'assistant',
        content: {
          text: "I'll transfer 100 USDC to alice.eth.",
          action: 'JEJU_SEND_TOKEN',
        },
      },
    ],
  ...
  examples: [
    [
      { name: 'user', content: { text: 'Swap 0.5 ETH for USDC' } },
      {
        name: 'assistant',
        content: {
          text: "I'll find the best route to swap 0.5 ETH for USDC.",
          action: 'JEJU_SWAP',
        },
      },
    ],
    [
      { name: 'user', content: { text: 'Trade 100 USDC for ETH on Base' } },
      {
        name: 'assistant',
        content: {
          text: "I'll swap 100 USDC for ETH on Base.",
          action: 'JEJU_SWAP',
        },
      },
    ],
...
export const portfolioAction: Action = {
  ...
  examples: [
    [
      ...
      {
        name: 'assistant',
        content: { text: "Here's your portfolio...", action: 'JEJU_PORTFOLIO' },
      },
    ],
    [
  ...
  examples: [
    [
      { name: 'user', content: { text: 'Register alice.jeju' } },
      {
        name: 'assistant',
        content: {
          text: "I'll help you register alice.jeju",
...
export const jejuWalletPlugin: Plugin = {
  name: 'jeju-wallet',
  description:
    'Agentic wallet with cross-chain, AA, pools, perps, launchpad, and JNS',

  providers: [walletStateProvider, portfolioProvider],
