 ...
 * Utils Unit Tests
 *
 * Tests for formatting utilities and edge cases.
 */

import { describe, test, expect } from 'bun:test';
import { formatEther, parseWei, sleep, shortenAddress } from './utils';
...
describe('formatEther', () => {
  ...
  describe('string input', () => {
    ...
    test('throws for empty string', () => {
      expect(() => formatEther('')).toThrow('formatEther: empty string provided');
    });

    test('throws for non-numeric strings', () => {
      expect(() => formatEther('abc')).toThrow('formatEther: invalid wei string');
    });

    test('throws for decimal strings', () => {
      expect(() => formatEther('1.5')).toThrow('formatEther: invalid wei string');
    });
