 ...
 *
 * SECURITY PROPERTIES:
 * 1. Private keys NEVER exist in full form in node memory
 * 2. All signing delegated to KMS (MPC/TEE threshold signatures)
 * 3. Key shares distributed across multiple parties
 * 4. TEE attestation required for sensitive operations
 *
 * This replaces direct privateKeyToAccount() usage throughout the codebase.
 */
