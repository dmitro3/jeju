...
const LOCALNET_ADDRESSES: ContractAddresses = {
  ...
  databaseProvider: '0x4A679253410272dd5232B3Ff7cF5dbB88f295319',
}
...
export function getContractAddresses(chainId: number): ContractAddresses {
  ...
  return {
    ...
    delegatedNodeStaking: safeGetAddress(
      'staking',
      'delegatedNode',
      network,
      'DELEGATED_NODE_STAKING',
    ),
    computeRegistry: safeGetAddress(
      'compute',
      'registry',
      network,
      'COMPUTE_REGISTRY',
    ),
    computeStaking: safeGetAddress(
      'compute',
      'staking',
      network,
      'COMPUTE_STAKING',
    ),
    inferenceServing: safeGetAddress(
      'compute',
      'inferenceServing',
      network,
      'INFERENCE_SERVING',
    ),
    triggerRegistry: safeGetAddress(
      'compute',
      'triggerRegistry',
      network,
      'TRIGGER_REGISTRY',
    ),
    storageMarket: safeGetAddress(
      'storage',
      'market',
      network,
      'STORAGE_MARKET',
    ),
    contentRegistry: safeGetAddress(
      'storage',
      'contentRegistry',
      network,
      'CONTENT_REGISTRY',
    ),
    oracleStakingManager: safeGetAddress(
      'oracle',
      'stakingManager',
      network,
      'ORACLE_STAKING_MANAGER',
    ),
    feedRegistry: safeGetAddress(
      'oracle',
      'feedRegistry',
      network,
      'FEED_REGISTRY',
    ),
    reportVerifier: safeGetAddress(
      'oracle',
      'reportVerifier',
      network,
      'REPORT_VERIFIER',
    ),
    proxyRegistry: safeGetAddress(
      'registry',
      'proxy',
      network,
      'PROXY_REGISTRY',
    ),
    sequencerRegistry: safeGetAddress(
      'registry',
      'sequencer',
      network,
      'SEQUENCER_REGISTRY',
    ),
    liquidityAggregator: safeGetAddress(
      'liquidity',
      'aggregator',
      network,
      'LIQUIDITY_AGGREGATOR',
    ),
    solverRegistry: safeGetAddress(
      'oif',
      'solverRegistry',
      network,
      'SOLVER_REGISTRY',
    ),
    feeDistributor: safeGetAddress(
      'fees',
      'feeDistributor',
      network,
      'FEE_DISTRIBUTOR',
    ),
    banManager: safeGetAddress(
      'moderation',
      'banManager',
      network,
      'BAN_MANAGER',
