...
Users pay gas in any token, or apps sponsor gas entirely.
...
### Option 2: App Sponsors Gas

App pays gas so users transact for free:
...
Tokens that can be used for gas:
