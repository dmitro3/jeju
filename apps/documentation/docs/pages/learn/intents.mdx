...
**Intents**: Declare your desired outcome, solvers handle the rest.
...
|-------|--------------|--------|
| Ethereum | Available | Live |
| Base | Available | Live |
| Arbitrum | Available | Live |
| Optimism | Available | Live |
| Polygon | Planned | Coming |

## For Users

Use the [Gateway](https://gateway.jejunetwork.org):
...
Register as a solver to earn from spreads:
