...
export function DWSStatus({ compact = false }: DWSStatusProps) {
  const { isConnected, isLoading, error, nodes, nodeCount, health, refresh } =
    useDWS()
    ...
    <div className="card p-4">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <span className="text-factory-300">
              No nodes available (using fallback)
            </span>
          </>
        )}
      </div>
          ...
          <div
            ...
            className={clsx(
              ...
              services[key]
                ...
                : 'bg-factory-900/50 text-factory-500',
            )}
          >
      ...
      {nodes.length > 0 && (
        <div className="mt-4 pt-4 border-t border-factory-800">
          <h4 className="text-sm font-medium text-factory-400 mb-2">
            Active Nodes
          </h4>
