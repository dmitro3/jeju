...
const mockJobs: Job[] = [
  {
    ...
    company: 'Jeju Labs',
    description:
      'Build and maintain core protocol contracts for the Jeju Network. Work on identity, bounties, guardians, and model registries.',
    type: 'full-time',
    location: 'remote',
    compensation: {
      min: 150000,
  ...
  },
  {
    ...
    company: 'Jeju Labs',
    description:
      'Build beautiful, performant UIs for Factory, Bazaar, and Gateway apps. Next.js, React, TypeScript, web3.',
    type: 'full-time',
    location: 'remote',
    compensation: {
      min: 120000,
  ...
  },
  {
    ...
    description:
      'Work on distributed training infrastructure and model hub integrations. PyTorch, distributed systems, CUDA.',
    type: 'full-time',
    location: 'remote',
    compensation: {
      min: 180000,
  ...
  },
  {
    ...
    company: 'Community',
    description:
      'Build and operate guardian agents to validate bounties and review code submissions. Earn fees and reputation.',
    type: 'contract',
    location: 'remote',
  ...
  },
  {
    ...
    company: 'Jeju Labs',
    description:
      'Create tutorials, documentation, and example apps. Help developers build on Jeju. Speak at conferences.',
    type: 'part-time',
    location: 'remote',
    compensation: {
      min: 60000,
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-factory-400 mt-1">
            Find work in the Jeju ecosystem
          </p>
        </div>
                ...
                <div className="flex items-start justify-between gap-4 mb-2">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-lg text-factory-100">
                        {job.title}
                      </h3>
                      {job.isUrgent && (
                  ...
                  <span
                    className={clsx('badge border', typeConfig[job.type].color)}
                  >
