...
const mockPackages = [
  {
    ...
    version: '1.5.2',
    description:
      'Official Jeju Network SDK - interact with contracts, bounties, guardians, and models.',
    downloads: 45230,
  ...
  },
  {
    ...
    version: '2.1.0',
    description:
      'TypeScript bindings for Jeju smart contracts - ready-to-use ABIs and type definitions.',
    downloads: 32150,
  ...
  },
  {
    ...
    version: '0.8.3',
    description:
      'Toolkit for building Jeju Guardians - validation utilities, reputation helpers, and review templates.',
    downloads: 8920,
    weeklyDownloads: 890,
  ...
  },
  {
    ...
    version: '1.2.1',
    description:
      'Client library for running inference on Jeju Model Hub - supports all major model types.',
    downloads: 15680,
  ...
  },
  {
    ...
    version: '0.5.0',
    description:
      'Distributed training coordinator for Psyche network integration with Jeju.',
    downloads: 5230,
    weeklyDownloads: 620,
  ...
  const filteredPackages = mockPackages
    ...
    .sort((a, b) => {
      switch (sortBy) {
        ...
        case 'recent':
          return b.lastPublish - a.lastPublish
        case 'quality':
    ...
    <div className="min-h-screen p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-factory-400 mt-1">
            Decentralized package registry on Jeju
          </p>
        </div>
      ...
      <div className="card p-6 mb-8">
        ...
        <div className="flex justify-center gap-3 mt-4">
          {(['popular', 'recent', 'downloads', 'quality'] as const).map(
            (sort) => (
              <button
                key={sort}
      ...
      {filteredPackages.length === 0 && (
        <div className="card p-12 text-center">
          ...
          <p className="text-factory-500 mb-4">
            Try a different search term or publish your own package
          </p>
          <Link href="/packages/publish" className="btn btn-primary">
            Publish Package
          </Link>
