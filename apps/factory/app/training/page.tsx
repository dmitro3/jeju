...
export default function TrainingPage() {
  useAccount()
  const [activeTab, setActiveTab] = useState<'runs' | 'models' | 'nodes'>(
    'runs',
  )
      ...
      setModels([
        {
          ...
          parameters: '8B',
          description:
            'Meta LLaMA 3 8B base model, optimized for instruction following and code generation.',
          downloads: 125000,
          canFinetune: true,
        },
        {
          ...
          parameters: '7B',
          description:
            'Mistral 7B v0.3 with sliding window attention and improved reasoning.',
          downloads: 89000,
          canFinetune: true,
        },
        {
          ...
          parameters: '3.8B',
          description:
            'Microsoft Phi-3 Mini, compact but powerful model for edge deployment.',
          downloads: 56000,
          canFinetune: true,
        },
        {
          ...
          parameters: '9B',
          description:
            'Google Gemma 2 9B, state-of-the-art open model for general purpose use.',
          downloads: 78000,
          canFinetune: true,
        },
      ])
        ...
        <div className="card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-factory-100">
                {runs
                  .reduce((sum, r) => sum + parseFloat(r.rewardsPool), 0)
                  .toFixed(2)}{' '}
                ETH
              </p>
    ...
    return (
      <div className="card p-12 text-center">
        ...
        <p className="text-factory-500 mb-4">
          Start a new distributed training run to fine-tune a model
        </p>
        <Link href="/training/create" className="btn btn-primary">
          <Plus className="w-4 h-4" />
          Create Training Run
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <div className="flex items-center gap-3 mb-1">
                ...
                {run.isOwner && <span className="badge badge-info">Owner</span>}
              </div>
        ...
        <div key={node.address} className="card p-4 card-hover">
          <div className="grid grid-cols-6 gap-4 items-center text-sm">
            ...
            <span
              className={clsx(
                'badge',
                node.gpuTier === 'High-End'
                  ? 'bg-purple-500/20 text-purple-400 border-purple-500/30'
                  : node.gpuTier === 'Datacenter'
                    ? 'bg-blue-500/20 text-blue-400 border-blue-500/30'
                    : node.gpuTier === 'Professional'
