...
const mockRepos = [
  {
    ...
    description:
      'Core smart contracts for the Jeju Network - identity registry, bounties, guardians, models, and more.',
    isPrivate: false,
    language: 'Solidity',
    stars: 234,
    forks: 45,
  ...
  },
  {
    ...
    description:
      'Developer coordination hub UI - bounties, jobs, git, packages, containers, models.',
    isPrivate: false,
    language: 'TypeScript',
    stars: 156,
    forks: 23,
  ...
  },
  {
    ...
    description:
      'Distributed training framework for Jeju model hub. Fork of Psyche with Jeju integrations.',
    isPrivate: false,
    language: 'Python',
    stars: 89,
    forks: 15,
