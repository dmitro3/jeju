...
export const MESSAGING_URL =
  process.env.NEXT_PUBLIC_MESSAGING_URL || 'http://localhost:3200'
export const CRUCIBLE_URL =
  process.env.NEXT_PUBLIC_CRUCIBLE_URL || 'http://localhost:4020'
export const AUTOCRAT_URL =
  process.env.NEXT_PUBLIC_AUTOCRAT_URL || 'http://localhost:4040'
export const KMS_ENDPOINT =
  process.env.NEXT_PUBLIC_KMS_ENDPOINT || 'http://localhost:4035'
...
export const FARCASTER_HUB_URL =
  process.env.FARCASTER_HUB_URL || 'https://hub.pinata.cloud'
export const NEYNAR_API_URL =
  process.env.NEXT_PUBLIC_NEYNAR_API_URL || 'https://api.neynar.com/v2'

// Factory channel on Farcaster
export const FACTORY_CHANNEL_ID =
  process.env.NEXT_PUBLIC_FACTORY_CHANNEL || 'factory'
...
export const JNS_CONFIG = {
  ...
  resolver:
    process.env.NEXT_PUBLIC_JNS_RESOLVER ||
