/**
 * Factory Full E2E Coverage Tests
 *
...
test.describe('Factory - Full Coverage', () => {
...
test.describe('Factory - Navigation', () => {
  ...
  test('should navigate to Bounties', async ({ page, baseURL }) => {
    await page.goto(`${baseURL}/bounties`)
    await page.waitForLoadState('domcontentloaded')
    await expect(page.locator('body')).toBeVisible()
  })

  test('should navigate to Projects', async ({ page, baseURL }) => {
...
test.describe('Factory - Button Interactions', () => {
...
test.describe('Factory - Form Interactions', () => {
...
test.describe('Factory - Error States', () => {
