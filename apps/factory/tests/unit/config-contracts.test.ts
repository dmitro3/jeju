...
const EXPECTED_LOCALNET_ADDRESSES = {
  ...
  paymentRequestRegistry: '0x0165878A594ca255338adfa4d48449f69242Eb8F' as Address,
  deepFundingDistributor: '0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6' as Address,
  ...
  workAgreementRegistry: '0xa513E6E4b8f2a923D98304ec87F64353C4D5C853' as Address,
};
...
describe('Switch Statement Chain Selection', () => {
  ...
  function selectAddressType(chainId: number): 'localnet' | 'testnet' | 'mainnet' {
    switch (chainId) {
      case 31337:
      case 1337:
        return 'localnet';
