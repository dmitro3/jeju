...
// EncodePayload implements bftraft.types.Handler.EncodePayload.
...
// DecodePayload implements bftraft.types.Handler.DecodePayload.
...
// Check implements bftraft.types.Handler.Check.
...
// TrackerAndResponse defines a query tracker used by dpos and an unsigned response.
type TrackerAndResponse struct {
	Tracker  *x.QueryTracker
	Response *types.Response
}

// Commit implements bftraft.types.Handler.Commit.
