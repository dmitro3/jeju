...
const (
	// ExchangeStateDetected defines the state for new tx to exchange for eqlite Particle.
...
type TxRecord struct {
	...
	// EQLite stuff
	EQLiteAccount string `db:"eqlite_account"`
	EQLiteAmount  uint64 `db:"eqlite_amount"`
	EQLiteTxHash  string `db:"eqlite_tx_hash"`
...
func UpsertTx(db *gorp.DbMap, r *TxRecord) (d *TxRecord, err error) {
	...
	d.EQLiteAccount = r.EQLiteAccount
	d.EQLiteAmount = r.EQLiteAmount
