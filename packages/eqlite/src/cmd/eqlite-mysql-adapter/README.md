This doc introduce the usage of EQLite mysql adapter. 
This adapter lets you use EQLite with any unmodified mysql client.
...
```shell
$ go get github.com/EQLite/EQLite/cmd/eqlite-mysql-adapter
```

Adapter requires a EQLite ```config.yaml``` which can by generated by configuration generator.  

### Generating Default Config File

Generate the main configuration file. Same as [Generating Default Config File in Golang Client Doc](https://github.com/EQLite/EQLite/tree/develop/client#generating-default-config-file). An existing configuration file can also be used.
...
```shell
$ eqlite-mysql-adapter --help
Usage of ./eqlite-mysql-adapter:
  -bypass-signature
    	Disable signature sign and verify, for testing
  -config string
    	config file for mysql adapter (default "~/.eqlite/config.yaml")
  -listen string
