...
// CmdConsole is eqlite console command entity.
var CmdConsole = &Command{
	UsageLine: "eqlite console [common params] [-command sqlcommand] [-out outputfile] [-no-rc true/false] [-single-transaction] [-variable variables] [-explorer explorer_addr] [-adapter adapter_addr] [dsn]",
	Short:     "run a console for interactive sql operation",
	Long: `
Console runs an interactive SQL console for EQLite.
e.g.
    eqlite console eqlite://4119ef997dedc585bfbcfae00ab6b87b8486fab323a8e107ea1fd4fc4f7eba5c
...
e.g.
    eqlite console -command "create table test1(test2 int);" eqlite://4119ef997dedc585bfbcfae00ab6b87b8486fab323a8e107ea1fd4fc4f7eba5c
`,
...
func usqlRegister() {
	...
	// register EQLite database
	drivers.Register("eqlite", drivers.Driver{
		AllowMultilineComments: true,
		Version: func(db drivers.DB) (string, error) {
			return Version, nil
		},
	...
	// register eqlite:// scheme to dburl
