...
// CmdIDMiner is eqlite idminer command entity.
var CmdIDMiner = &Command{
	UsageLine: "eqlite idminer [common params] [-difficulty number] [-loop [true]]",
...
no endless loop.
e.g.
    eqlite idminer -difficulty 24

If you want mining a good id, use:
    eqlite idminer -config ~/.eqlite/config.yaml -loop -difficulty 24
`,
