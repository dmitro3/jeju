...
func startNodes() {
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/leader.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/follower1.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/follower2.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/miner0.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/miner1.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite-fuse/miner2.cover.out"),
		},
