...
func startNodes() {
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/leader-mirror.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/follower1-mirror.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/follower2-mirror.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_miner_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/miner0-mirror.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_miner_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/miner1-mirror.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./mirror/node_miner_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/miner2-mirror.cover.out"),
		},
...
func TestFullProcess(t *testing.T) {
	...
	Convey("test mirror full process", t, func() {
		...
		mirrorCmd, err = utils.RunCommandNB(
			FJ(baseDir, "./bin/eqlite.test"),
			[]string{"-test.coverprofile", FJ(baseDir, "./cmd/eqlite/mirror.cover.out"),
				"mirror",
		...
		dbMirror, err := sql.Open("eqlite", mirrorDSN)
		So(err, ShouldBeNil)
