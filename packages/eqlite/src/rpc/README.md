[![Go Report Card](https://goreportcard.com/badge/github.com/EQLite/EQLite?style=flat-square)](https://goreportcard.com/report/github.com/EQLite/EQLite)
[![Coverage](https://codecov.io/gh/EQLite/EQLite/branch/develop/graph/badge.svg)](https://codecov.io/gh/EQLite/EQLite/tree/develop/rpc)
[![Build Status](https://travis-ci.org/EQLite/EQLite.png?branch=develop)](https://travis-ci.org/EQLite/EQLite)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/EQLite/EQLite)
...
EQLite is built on DH-RPC, including:

- Byzantine Fault Tolerance consensus protocol [BftRaft](https://godoc.org/github.com/EQLite/EQLite/bftraft)
...
![](https://cdn.jsdelivr.net/gh/EQLite/EQLite@cc4aa933d80a5d31738081d13c7b1587ad47cffb/logo/dh-rpc.svg)
...
- DHT persistence layer has 2 implementations:
    ...
    - [BftRaft](https://godoc.org/github.com/EQLite/EQLite/bftraft) based 2PC strong consistent DHT
...
<p align="left">
  ...
  - [DH-RPC](rpc/) = TLS - Cert + DHT
    ...
    - Naming Layer: [**C**onsistent **S**ecure **DHT**](https://godoc.org/github.com/EQLite/EQLite/consistent)
    - Pooling Layer: session pool built on Yamux
    - Multiplex Layer: Yamux by Hashicorp
    - Transport Security Layer: [**E**nhanced **TLS**](https://github.com/EQLite/research/wiki/ETLS(Enhanced-Transport-Layer-Security))
...
import (
	...
	"github.com/EQLite/EQLite/conf"
	"github.com/EQLite/EQLite/consistent"
	"github.com/EQLite/EQLite/route"
	"github.com/EQLite/EQLite/rpc"
	"github.com/EQLite/EQLite/utils/log"
)
...
import (
	...
	"github.com/EQLite/EQLite/conf"
	"github.com/EQLite/EQLite/proto"
	"github.com/EQLite/EQLite/route"
	"github.com/EQLite/EQLite/rpc"
	"github.com/EQLite/EQLite/utils/log"
)
