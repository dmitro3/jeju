...
// eqlite_secp256k1_ext_scalar_mul multiplies a point by a scalar in constant time.
//
...
int eqlite_secp256k1_ext_scalar_mul(const secp256k1_context* ctx, unsigned char *point, const unsigned char *scalar) {
	int ret = 0;
	int overflow = 0;
