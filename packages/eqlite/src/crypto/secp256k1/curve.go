...
extern int eqlite_secp256k1_ext_scalar_mul(const secp256k1_context* ctx, const unsigned char *point, const unsigned char *scalar);
*/
import "C"
...
func (BitCurve *BitCurve) ScalarMult(Bx, By *big.Int, scalar []byte) (*big.Int, *big.Int) {
	...
	res := C.eqlite_secp256k1_ext_scalar_mul(context, pointPtr, scalarPtr)
