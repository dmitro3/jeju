 ...
 * from PostgreSQL/Neon to EQLite.
 *
 * @example
 * ```typescript
 * import { drizzle } from '@jejunetwork/eqlite/drizzle'
...
// ============================================================================
// EQLite Drizzle Database
// ============================================================================

export class EQLiteDrizzle {
...
/**
 * Create a Drizzle-compatible EQLite database instance
 *
 * @example
 * ```typescript
 * const db = await drizzle({
 ...
 * ```
 */
export async function drizzle(config: DrizzleConfig): Promise<EQLiteDrizzle> {
  const db = new EQLiteDrizzle(config)
  await db.connect()
  return db
}
