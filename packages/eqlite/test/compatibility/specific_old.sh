...
case $test_case in
    "client")
        CLIENTBIN=${OLD_BIN_DIR}/eqlite
        BPBIN=${NEW_BIN_DIR}/eqlited
        MINERBIN=${NEW_BIN_DIR}/eqlite-minerd
        ;;
    "bp")
        CLIENTBIN=${NEW_BIN_DIR}/eqlite
        BPBIN=${OLD_BIN_DIR}/eqlited
        MINERBIN=${NEW_BIN_DIR}/eqlite-minerd
        ;;
    "miner")
        CLIENTBIN=${NEW_BIN_DIR}/eqlite
        BPBIN=${NEW_BIN_DIR}/eqlited
        MINERBIN=${OLD_BIN_DIR}/eqlite-minerd
        ;;
    *)
        exit 1
        ;;
