 ...
 * Uses describeWithInfra to skip when EQLite is not running
 */

import { beforeEach, describe, expect, it } from 'bun:test'
import { describeWithInfra } from '@jejunetwork/tests/shared/live-infrastructure'
...
// Tests that work without EQLite (in-memory mode) - skip these for now since ExtendedTaskStore requires EQLite
describe.skip('ExtendedTaskStore (in-memory fallback)', () => {
  it('should provide graceful degradation when EQLite is unavailable', () => {
    // Placeholder - in the future we could add in-memory fallback
