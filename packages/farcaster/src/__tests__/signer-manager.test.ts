...
describe('FarcasterSignerManager', () => {
  ...
  describe('sign', () => {
    it('throws for non-existent signer', async () => {
      ...
      await expect(manager.sign('non-existent', message)).rejects.toThrow('not found');
    });
    ...
    it('throws for non-active signer', async () => {
      ...
      await expect(manager.sign(signer.keyId, message)).rejects.toThrow('not active');
    });
  ...
  describe('markApproved', () => {
    ...
    it('throws for non-existent signer', async () => {
      await expect(manager.markApproved('non-existent')).rejects.toThrow('not found');
    });
  });
  ...
  describe('revokeSigner', () => {
    ...
    it('throws for non-existent signer', async () => {
      await expect(manager.revokeSigner('non-existent')).rejects.toThrow('not found');
    });
  });
  ...
  describe('getSignerPublicKeyBytes', () => {
    it('throws for non-existent signer', async () => {
      await expect(manager.getSignerPublicKeyBytes('non-existent')).rejects.toThrow('not found');
    });
  ...
  describe('exportSigner', () => {
    it('throws for non-existent signer', async () => {
      await expect(manager.exportSigner('non-existent')).rejects.toThrow('not found');
    });
