...
let isBoolean: ((val: unknown) => boolean) | undefined
let isBuffer: ((val: unknown) => boolean) | undefined
let isDate: ((val: unknown) => boolean) | undefined
let isError: ((val: unknown) => boolean) | undefined
let isFunction: ((val: unknown) => boolean) | undefined
let isNull: ((val: unknown) => boolean) | undefined
let isNullOrUndefined: ((val: unknown) => boolean) | undefined
let isNumber: ((val: unknown) => boolean) | undefined
let isObject: ((val: unknown) => boolean) | undefined
let isPrimitive: ((val: unknown) => boolean) | undefined
let isRegExp: ((val: unknown) => boolean) | undefined
let isString: ((val: unknown) => boolean) | undefined
let isSymbol: ((val: unknown) => boolean) | undefined
let isUndefined: ((val: unknown) => boolean) | undefined
