...
import { FullValidationRunner, type FullValidationConfig } from './full-validation'
...
async function main() {
  ...
  const config: FullValidationConfig = {
    strategy: 'momentum',
    tokens: [
      { symbol: 'ETH', address: '0x4200000000000000000000000000000000000006', decimals: 18, chainId: 8453 },
  ...
  console.log(`Grade: ${result.summary.grade} (${result.summary.overallScore}/100)`)
}
