 ...
 * @jejunetwork/sqlit
 *
 * SQLIT (SQLIT) for Jeju Network - TypeScript Driver.
 *
 * Features:
 * - Connection pooling for efficient database access
 * - Native SQLIT proxy API (/v1/query, /v1/exec)
 * - Node discovery from on-chain SQLIT Registry
 * - Transaction support with savepoints
 * - Health checking and automatic reconnection
 *
 * @example
 * ```typescript
 * import { createConnection, createPool } from '@jejunetwork/sqlit'
 *
 * // Simple connection
