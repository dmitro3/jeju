/**
 * Transaction support for SQLIT
 *
 * Provides ACID transaction semantics for SQLIT databases.
 * Note: SQLIT has limited atomicity - transactions work best on leader nodes.
 */
...
export interface TransactionOptions {
   ...
   * SQLIT supports: READ_UNCOMMITTED, READ_COMMITTED, REPEATABLE_READ, SERIALIZABLE
   */
  isolationLevel?:
    | 'READ_UNCOMMITTED'
    | 'READ_COMMITTED'
