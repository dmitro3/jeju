...
// StartSucceedMessage is printed when SQLIT started successfully.
const StartSucceedMessage = "SQLIT Started Successfully"
...
type BPInfo struct {
	...
	// Nonce is the nonce, SEE: cmd/sqlit for more
