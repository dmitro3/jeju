This doc introduce the usage of SQLIT mysql adapter. 
This adapter lets you use SQLIT with any unmodified mysql client.
...
```shell
$ go get github.com/SQLIT/SQLIT/cmd/sqlit-mysql-adapter
```

Adapter requires a SQLIT ```config.yaml``` which can by generated by configuration generator.  

### Generating Default Config File

Generate the main configuration file. Same as [Generating Default Config File in Golang Client Doc](https://github.com/SQLIT/SQLIT/tree/develop/client#generating-default-config-file). An existing configuration file can also be used.
...
```shell
$ sqlit-mysql-adapter --help
Usage of ./sqlit-mysql-adapter:
  -bypass-signature
    	Disable signature sign and verify, for testing
  -config string
    	config file for mysql adapter (default "~/.sqlit/config.yaml")
  -listen string
