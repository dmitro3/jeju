...
func startNodes() {
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/leader.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/follower1.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/follower2.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/miner0.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/miner1.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./fuse/node_miner_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlit-fuse/miner2.cover.out"),
		},
