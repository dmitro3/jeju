...
func start3BPs() {
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_0/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlitd/leader.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_1/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlitd/follower1.cover.out"),
		},
	...
	if cmd, err = utils.RunCommandNB(
		...
		[]string{"-config", FJ(testWorkingDir, "./node_2/config.yaml"),
			"-test.coverprofile", FJ(baseDir, "./cmd/sqlitd/follower2.cover.out"),
		},
