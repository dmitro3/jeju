...
// CmdConsole is sqlit console command entity.
var CmdConsole = &Command{
	UsageLine: "sqlit console [common params] [-command sqlcommand] [-out outputfile] [-no-rc true/false] [-single-transaction] [-variable variables] [-explorer explorer_addr] [-adapter adapter_addr] [dsn]",
	Short:     "run a console for interactive sql operation",
	Long: `
Console runs an interactive SQL console for SQLIT.
e.g.
    sqlit console sqlit://4119ef997dedc585bfbcfae00ab6b87b8486fab323a8e107ea1fd4fc4f7eba5c
...
func usqlRegister() {
	...
	// register SQLIT database
	drivers.Register("sqlit", drivers.Driver{
		AllowMultilineComments: true,
		Version: func(db drivers.DB) (string, error) {
			return Version, nil
		},
	...
	// register sqlit:// scheme to dburl
