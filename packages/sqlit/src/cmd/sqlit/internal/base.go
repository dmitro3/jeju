...
var (
	...
	// SqlitCommands initialized in package main
	SqlitCommands []*Command
)
...
// A Command is an implementation of a sqlit command
// like sqlit create or sqlit transfer.
type Command struct {
	...
	// Short is the short description shown in the 'sqlit help' output.
	Short string

	// Long is the long message shown in the 'sqlit help <this-command>' output.
	Long string
...
// LongName returns the command's long name: all the words in the usage line between "sqlit" and a flag or argument,
func (c *Command) LongName() string {
	...
	return strings.TrimPrefix(name, "sqlit ")
}
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stdout, "Run 'sqlit help %s' for details.\n", c.LongName())
	os.Exit(2)
}
