...
// CmdDrop is sqlit drop command entity.
var CmdDrop = &Command{
	UsageLine: "sqlit drop [common params] [-wait-tx-confirm] dsn",
	Short:     "drop a database by dsn or database id",
	Long: `
Drop drops a SQLIT database by DSN or database ID.
e.g.
    sqlit drop sqlit://4119ef997dedc585bfbcfae00ab6b87b8486fab323a8e107ea1fd4fc4f7eba5c
...
e.g.
    sqlit drop -wait-tx-confirm sqlit://4119ef997dedc585bfbcfae00ab6b87b8486fab323a8e107ea1fd4fc4f7eba5c
`,
...
func runDrop(cmd *Command, args []string) {
	...
	if len(args) != 1 {
		ConsoleLog.Error("drop command need SQLIT dsn or database_id string as param")
		SetExitStatus(1)
