...
// CmdAdapter is sqlit adapter command entity.
var CmdAdapter = &Command{
	UsageLine: "sqlit adapter [common params] [-tmp-path path] [-bg-log-level level] [-mirror addr] listen_address",
	Short:     "start a SQLChain adapter server",
	Long: `
Adapter serves a SQLChain adapter.
e.g.
    sqlit adapter 127.0.0.1:7784
`,
