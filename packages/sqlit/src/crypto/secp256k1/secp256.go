...
extern void sqlit_secp256k1GoPanicIllegal(const char* msg, void* data);
extern void sqlit_secp256k1GoPanicError(const char* msg, void* data);
*/
import "C"
...
func init() {
	...
	C.secp256k1_context_set_illegal_callback(context, C.callbackFunc(C.sqlit_secp256k1GoPanicIllegal), nil)
	C.secp256k1_context_set_error_callback(context, C.callbackFunc(C.sqlit_secp256k1GoPanicError), nil)
}
...
func Sign(msg []byte, seckey []byte) ([]byte, error) {
	...
	var (
		...
		noncefunc = C.sqlit_secp256k1_nonce_function_rfc6979
