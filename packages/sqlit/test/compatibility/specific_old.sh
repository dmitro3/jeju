...
case $test_case in
    "client")
        CLIENTBIN=${OLD_BIN_DIR}/sqlit
        BPBIN=${NEW_BIN_DIR}/sqlitd
        MINERBIN=${NEW_BIN_DIR}/sqlit-minerd
        ;;
    "bp")
        CLIENTBIN=${NEW_BIN_DIR}/sqlit
        BPBIN=${OLD_BIN_DIR}/sqlitd
        MINERBIN=${NEW_BIN_DIR}/sqlit-minerd
        ;;
    "miner")
        CLIENTBIN=${NEW_BIN_DIR}/sqlit
        BPBIN=${NEW_BIN_DIR}/sqlitd
        MINERBIN=${OLD_BIN_DIR}/sqlit-minerd
        ;;
    *)
        exit 1
        ;;
