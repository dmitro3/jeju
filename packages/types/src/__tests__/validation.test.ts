...
describe('UrlSchema', () => {
  test('accepts valid URLs', () => {
    ...
    expect(
      UrlSchema.safeParse('https://api.example.com/v1/endpoint').success,
    ).toBe(true)
  })
...
describe('IsoDateSchema', () => {
  test('accepts valid ISO 8601 dates', () => {
    ...
    expect(IsoDateSchema.safeParse('2024-01-15T12:30:00.000Z').success).toBe(
      true,
    )
  })
...
describe('ChainIdSchema', () => {
  ...
  test.each(
    invalidChainIds,
  )('rejects invalid chain ID: %d', (chainId: number) => {
...
describe('PaginationSchema', () => {
  ...
  test('validates sortOrder enum', () => {
    ...
    expect(PaginationSchema.safeParse({ sortOrder: 'invalid' }).success).toBe(
      false,
    )
  })
})
...
describe('expectTrue', () => {
  ...
  test('throws when false', () => {
    ...
    const one: number = 1
    const two: number = 2
    expect(() => expectTrue(one === two, 'one is not two')).toThrow(
      'one is not two',
    )
  })
})
...
describe('expectDefined', () => {
  ...
  test('throws when null or undefined', () => {
    ...
    expect(() => expectDefined(undefinedValue, 'was undefined')).toThrow(
      'was undefined',
    )
  })
})
...
describe('expectPositive', () => {
  ...
  test('returns positive bigint', () => {
    ...
    expect(expectPositive(1000000000000000000n, 'value')).toBe(
  ...
  test('throws on negative', () => {
    ...
    expect(() => expectPositive(-1n, 'value')).toThrow(
...
describe('expectNonNegative', () => {
  ...
  test('throws on negative', () => {
    expect(() => expectNonNegative(-1, 'value')).toThrow(
      'value: must be non-negative',
    )
    expect(() => expectNonNegative(-1n, 'value')).toThrow(
      'value: must be non-negative',
    )
  })
})
...
describe('expectValid', () => {
  ...
  test('throws on validation failure', () => {
    expect(() => expectValid(TestSchema, { name: 'Bob', age: -1 })).toThrow(
      'Validation failed',
    )
  })
  ...
  test('includes context in error message', () => {
    expect(() =>
      expectValid(TestSchema, { name: 'Bob', age: -1 }, 'user input'),
    ).toThrow('Validation failed in user input')
  })

  test('includes field path in error', () => {
    expect(() => expectValid(TestSchema, { name: 123, age: 30 })).toThrow(
      /name/,
    )
  })
})
...
describe('expectAddress', () => {
  ...
  test('includes context in error', () => {
    expect(() => expectAddress('0x123', 'recipient')).toThrow(
...
describe('expectHex', () => {
  ...
  test('includes context in error', () => {
    expect(() => expectHex('invalid', 'calldata')).toThrow(
      'calldata: Invalid hex',
    )
  })
})
...
describe('expectChainId', () => {
  ...
  test('includes context in error', () => {
    expect(() => expectChainId(0, 'source chain')).toThrow(
      'source chain: Invalid chain ID',
    )
  })
})
...
describe('expectBigInt', () => {
  ...
  test('uses custom field name in error', () => {
    expect(() => expectBigInt('invalid' as string, 'amount')).toThrow(
      'Invalid amount',
    )
  })
})
...
describe('expectNonEmptyString', () => {
  ...
  test('throws on null/undefined', () => {
    ...
    expect(() => expectNonEmptyString(undefined, 'name')).toThrow(
      'Invalid name',
    )
  })
})
...
describe('expectJson', () => {
  ...
  test('uses custom field name', () => {
    expect(() => expectJson('invalid', schema, 'config')).toThrow(
      'Invalid config',
    )
  })
})
...
describe('CidSchema', () => {
  test('accepts non-empty CID strings', () => {
    expect(
      CidSchema.safeParse('QmYwAPJzv5CZsnA625s3Xf2nemtYgPpHdWEz79ojWnPbdG')
        .success,
    ).toBe(true)
    expect(
      CidSchema.safeParse(
