...
export const CONTRIBUTOR_TYPES: ContributorType[] = ['INDIVIDUAL', 'ORGANIZATION', 'PROJECT'];

export type VerificationStatus = 'UNVERIFIED' | 'PENDING' | 'VERIFIED' | 'REVOKED';
export const VERIFICATION_STATUSES: VerificationStatus[] = ['UNVERIFIED', 'PENDING', 'VERIFIED', 'REVOKED'];

export type SocialPlatform = 'github' | 'discord' | 'twitter' | 'farcaster';
export const SOCIAL_PLATFORMS: SocialPlatform[] = ['github', 'discord', 'twitter', 'farcaster'];
...
export const PAYMENT_CATEGORY_DISPLAY: Record<PaymentCategory, { label: string; icon: string; color: string }> = {
...
export const PAYMENT_STATUS_DISPLAY: Record<PaymentRequestStatus, { label: string; bgClass: string; textClass: string }> = {
  SUBMITTED: { label: 'Submitted', bgClass: 'bg-slate-500/20', textClass: 'text-slate-400' },
  COUNCIL_REVIEW: { label: 'Council Review', bgClass: 'bg-amber-500/20', textClass: 'text-amber-400' },
  CEO_REVIEW: { label: 'CEO Review', bgClass: 'bg-purple-500/20', textClass: 'text-purple-400' },
  APPROVED: { label: 'Approved', bgClass: 'bg-emerald-500/20', textClass: 'text-emerald-400' },
  REJECTED: { label: 'Rejected', bgClass: 'bg-rose-500/20', textClass: 'text-rose-400' },
  PAID: { label: 'Paid', bgClass: 'bg-indigo-500/20', textClass: 'text-indigo-400' },
  DISPUTED: { label: 'Disputed', bgClass: 'bg-orange-500/20', textClass: 'text-orange-400' },
  CANCELLED: { label: 'Cancelled', bgClass: 'bg-slate-500/20', textClass: 'text-slate-500' },
};
...
export const REGISTRY_TYPES: RegistryType[] = ['npm', 'pypi', 'cargo', 'go', 'unknown'];
