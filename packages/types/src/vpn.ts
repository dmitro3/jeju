...
export const VPN_LEGAL_COUNTRIES: CountryLegalStatus[] = [
  ...
  },
  {
    ...
    canBeClient: true,
    requiresExtraConsent: true,
    notes: 'Evolving legal situation',
  },
  {
    countryCode: 'BR',
    vpnLegal: true,
  ...
  },
  {
    ...
    canBeClient: true,
    requiresExtraConsent: true,
    notes: 'VPN providers must keep logs',
  },
  ...
  // Blocked countries - VPN illegal or heavily restricted
  {
    ...
    canBeClient: false,
    requiresExtraConsent: false,
    notes: 'VPN illegal without license',
  },
  {
    countryCode: 'RU',
    vpnLegal: false,
  ...
  },
  {
    ...
    canBeClient: false,
    requiresExtraConsent: false,
    notes: 'VPN illegal for individuals',
  },
  {
    countryCode: 'TM',
    vpnLegal: false,
...
export type VPNNodeRegisteredEvent = z.infer<
  typeof VPNNodeRegisteredEventSchema
>
...
export type VPNSessionStartedEvent = z.infer<
  typeof VPNSessionStartedEventSchema
>
