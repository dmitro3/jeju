...
/**
 * @title NetworkTokenTest
 * @notice Comprehensive tests for NetworkToken contract
 */
contract NetworkTokenTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy NetworkToken with BanManager and faucet enabled
    ...
    function test_Mint_MaxSupply() public {
        ...
        vm.prank(owner);
        vm.expectRevert(NetworkToken.MaxSupplyExceeded.selector);
        jeju.mint(alice, 1);
    }
    ...
    function test_BannedSenderCannotTransfer() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(NetworkToken.BannedUser.selector, alice));
    ...
    function test_BannedReceiverCannotReceive() public {
        ...
        vm.prank(owner);
        vm.expectRevert(abi.encodeWithSelector(NetworkToken.BannedUser.selector, bob));
        jeju.transfer(bob, amount);
    }
    ...
    function test_FaucetDisabled() public {
        ...
        vm.prank(alice);
        vm.expectRevert(NetworkToken.FaucetDisabled.selector);
        jeju.faucet();
    }
    ...
    function test_NoBanManagerSet() public {
        ...
        NetworkToken jejuNoBan = new NetworkToken(owner, address(0), true);
...
/**
 * @title NetworkTokenIntegrationTest
 * @notice Integration tests with multiple contracts
 */
contract NetworkTokenIntegrationTest is Test {
    NetworkToken public jeju;
    BanManager public banManager;
    ...
    function test_MultipleUsersInteraction() public {
        ...
        vm.prank(users[1]);
        vm.expectRevert(abi.encodeWithSelector(NetworkToken.BannedUser.selector, users[2]));
