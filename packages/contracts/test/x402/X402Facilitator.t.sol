...
contract X402FacilitatorTest is Test {
    ...
    function test_SettlePayment_RevertIfUnsupportedToken() public {
        ...
        facilitator.settle(payer, recipient, unsupportedToken, 100, "/api/data", "nonce", block.timestamp, "");
    }
    ...
    function test_SettlePayment_RevertIfExpired() public {
        ...
        facilitator.settle(payer, recipient, address(usdc), amount, "/api/data", "nonce", timestamp, "");
    }
