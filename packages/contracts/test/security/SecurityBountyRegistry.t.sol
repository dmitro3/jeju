...
contract MockIdentityRegistry {
    ...
    function getAgentProfile(uint256)
        external
        pure
        returns (string memory name, string memory description, string memory avatarCid, bool nsfw)
    {
...
contract SecurityBountyRegistryTest is Test {
    ...
    function test_CompleteValidation() public {
        ...
        registry.completeValidation(
            submissionId, SecurityBountyRegistry.ValidationResult.VERIFIED, "Exploit confirmed in sandbox", 0.01 ether
        );
    }
