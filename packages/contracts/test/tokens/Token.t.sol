...
contract TokenTest is Test {
    ...
    function test_TransferWithAuthorization() public {
        ...
        bytes32 structHash = keccak256(
            abi.encode(
                token.TRANSFER_WITH_AUTHORIZATION_TYPEHASH(), signer, user1, value, validAfter, validBefore, nonce
            )
        );
        ...
        token.transferWithAuthorization(signer, user1, value, validAfter, validBefore, nonce, signature);
