...
contract RegistryHubTest is Test {
    ...
    function test_RegisterChainUnstaked() public {
        vm.prank(operator1);
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Test Network", "https://rpc.test.network");
    ...
    function test_RegisterChainStaked() public {
        ...
        hub.registerChain{value: 1 ether}(
            CHAIN_ID_1, RegistryHub.ChainType.EVM, "Staked Network", "https://rpc.staked.network"
        );
    ...
    function test_RegisterChainVerified() public {
        ...
        hub.registerChain{value: 10 ether}(
            CHAIN_ID_1, RegistryHub.ChainType.EVM, "Verified Network", "https://rpc.verified.network"
        );
    ...
    function test_AddStakeUpgradesTier() public {
        // Register unstaked
        vm.prank(operator1);
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Upgrade Network", "https://rpc.upgrade.network");
    ...
    function test_RegisterRegistry() public {
        ...
        vm.prank(operator1);
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Registry Network", "https://rpc.registry.network");
        ...
        bytes32 registryId = hub.computeRegistryId(CHAIN_ID_1, RegistryHub.RegistryType.IDENTITY, contractAddress);
    ...
    function test_IsTrustedForConsensus() public {
        // Unstaked chain
        vm.prank(operator1);
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Unstaked", "https://rpc.unstaked.network");
        ...
        vm.prank(operator2);
        hub.registerChain{value: 1 ether}(CHAIN_ID_2, RegistryHub.ChainType.EVM, "Staked", "https://rpc.staked.network");
    ...
    function test_RegisterSolanaRegistry() public {
        ...
        hub.registerSolanaRegistry{value: 1 ether}(
            programId, RegistryHub.RegistryType.IDENTITY, "Solana Identity", "ipfs://solana-metadata"
        );
    ...
    function test_RevertWhen_RegisterChainTwice() public {
        ...
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "First", "https://rpc.first.network");

        vm.expectRevert(RegistryHub.ChainExists.selector);
        hub.registerChain(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Second", "https://rpc.second.network");
        vm.stopPrank();
    }
    ...
    function test_RevertWhen_WithdrawStakeWhileActive() public {
        vm.deal(operator1, 2 ether);
        vm.startPrank(operator1);
        hub.registerChain{value: 1 ether}(CHAIN_ID_1, RegistryHub.ChainType.EVM, "Active", "https://rpc.active.network");
    ...
    function test_DeactivateAndWithdraw() public {
        ...
        hub.registerChain{value: 1 ether}(
            CHAIN_ID_1, RegistryHub.ChainType.EVM, "Deactivate", "https://rpc.deactivate.network"
        );
