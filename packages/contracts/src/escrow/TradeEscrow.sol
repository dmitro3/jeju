 ...
 * @title TradeEscrow
 * @author Jeju Network
 * @notice Secure P2P trading escrow supporting ERC-20, ERC-721, and ERC-1155 tokens
 * @dev Generic escrow system for safe peer-to-peer trades supporting:
 *      - ERC-20 tokens
 *      - ERC-721 NFTs
 *      - ERC-1155 tokens (stackable and unique)
 *      - Multi-asset trades (mix of different token types)
 *      - Atomic execution (all or nothing)
 *      - Review period before confirmation
 *
 * Trade Flow:
 * 1. Party A creates trade with Party B
 * 2. Party A deposits their offered assets
 * 3. Party B deposits their offered assets
 * 4. Both parties review and confirm
 * 5. Trade executes atomically
 *
 * Safety Features:
 * - Both parties must confirm before execution
 * - Either party can cancel before both confirm
 ...
 */
contract TradeEscrow is IERC721Receiver, IERC1155Receiver, ReentrancyGuard, Ownable {
