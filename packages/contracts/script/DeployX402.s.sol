...
contract DeployX402 is Script {
    function run() external {
        ...
        X402Facilitator facilitator = new X402Facilitator(deployer, feeRecipient, tokens);
        ...
        if (oracleAddress != address(0)) {
            X402IntentBridge bridge = new X402IntentBridge(address(facilitator), oracleAddress, deployer);
