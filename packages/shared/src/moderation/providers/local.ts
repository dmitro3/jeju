...
const HIGH_CONFIDENCE_KEYWORDS = new Set([
  'childporn', 'child porn', 'child pornography', 'kiddie porn',
  'pedo', 'pedophile', 'pedophilia', 'pthc', 'ptsc', 'hussyfan',
  'preteen', 'pre-teen', 'jailbait', 'toddlercon',
...
const CONTEXT_REQUIRED_KEYWORDS = new Set([
  ...
  'shota', 'shotacon', // Anime terms
  'age play', 'ageplay', 'dd/lg', 'ddlg', 'cgl', // Could be adult roleplay
  'young lover', 'little lover', // Could be age-gap adult relationship
])

// Context words that make ambiguous keywords suspicious
const SUSPICIOUS_CONTEXT = [
  'trade', 'trading', 'swap', 'swapping', 'share', 'sharing', 'link', 'links',
  'pic', 'pics', 'photo', 'photos', 'video', 'videos', 'content', 'collection',
  'nude', 'naked', 'sex', 'porn', 'fuck', 'hot', 'sexy',
  'want', 'looking for', 'anyone have', 'anyone got', 'where to find',
  'dm', 'telegram', 'wickr', 'onion', 'tor', 'mega', 'download',
]
