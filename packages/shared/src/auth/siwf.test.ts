...
describe('formatSIWFMessage', () => {
  test('formats message correctly', () => {
    ...
    expect(formatted).toContain('example.com wants you to sign in with your Farcaster account:');
    expect(formatted).toContain('FID: 12345');
    expect(formatted).toContain('Custody Address: 0x1234567890123456789012345678901234567890');
