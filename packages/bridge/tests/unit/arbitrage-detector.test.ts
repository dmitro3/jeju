...
describe('ArbitrageDetector', () => {
  ...
  beforeEach(() => {
    detector = createArbitrageDetector({ minProfitBps: 100 });
  });
      ...
      const opportunities: ArbOpportunity[] = [
        {
          ...
          route: { steps: [], totalGasEstimate: 500000n, totalTimeSeconds: 300 },
        },
        {
          id: 'opp2',
          type: 'solana_evm',
    ...
    it('should sort opportunities by net profit descending', () => {
      const opportunities: ArbOpportunity[] = [
        ...
        },
        {
          ...
          netProfitUsd: 495,
          expiresAt: Date.now() + 30000,
          route: { steps: [], totalGasEstimate: 300000n, totalTimeSeconds: 120 },
        },
        {
          id: 'medium',
          type: 'hyperliquid',
          ...
          route: { steps: [], totalGasEstimate: 400000n, totalTimeSeconds: 180 },
        },
      ];
