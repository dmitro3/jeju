...
async function main() {
  ...
  if (!envKey && network !== "localnet") {
    throw new Error(`DEPLOYER_PRIVATE_KEY or PRIVATE_KEY environment variable required for ${network}`);
  }
  const privateKey = (envKey || "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80") as Hex;
