...
describe("getArchitecture", () => {
  ...
  it("should throw for unsupported architectures", () => {
    expect(() => getArchitecture("ia32")).toThrow("Unsupported architecture: ia32");
    expect(() => getArchitecture("arm")).toThrow("Unsupported architecture: arm");
    expect(() => getArchitecture("mips")).toThrow("Unsupported architecture: mips");
    expect(() => getArchitecture("")).toThrow("Unsupported architecture:");
  });

  it("should be case-sensitive", () => {
    expect(() => getArchitecture("X64")).toThrow("Unsupported architecture: X64");
    expect(() => getArchitecture("ARM64")).toThrow("Unsupported architecture: ARM64");
  });
});
