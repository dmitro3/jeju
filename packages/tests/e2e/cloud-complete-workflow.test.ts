...
const CREDIT_MANAGER_ADDRESS = (tryGetContract('tokens', 'usdc', 'localnet') ||
  '0x0000000000000000000000000000000000000000') as Address
...
if (!localnetAvailable) {
  console.log(
    '⏭️  Skipping Complete User Workflow E2E tests - localnet not available at',
    RPC_URL,
  )
} else if (!cloudContractsDeployed) {
  console.log(
    '⏭️  Skipping Complete User Workflow E2E tests - CloudIntegration contracts not deployed',
  )
}
