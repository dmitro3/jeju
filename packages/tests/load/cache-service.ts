...
const app = new Elysia()
  ...
  // Multi-get
  .post('/cache/mget', ({ body }) => {
    const { keys, namespace = 'default' } = body as {
      keys: string[]
      namespace?: string
    }
  ...
  // Multi-set
  .post('/cache/mset', ({ body }) => {
    const { entries, namespace = 'default' } = body as {
