...
describe('AddressSchema - Ethereum Address Validation', () => {
  test('should accept valid checksummed address', () => {
    const result = AddressSchema.safeParse('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266');
  ...
  test('should accept zero address', () => {
    const result = AddressSchema.safeParse('0x0000000000000000000000000000000000000000');
    expect(result.success).toBe(true);
  });

  test('should reject address without 0x prefix', () => {
    const result = AddressSchema.safeParse('f39Fd6e51aad88F6F4ce6aB8827279cffFb92266');
    expect(result.success).toBe(false);
  });

  test('should reject short address', () => {
    const result = AddressSchema.safeParse('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb9226');
    expect(result.success).toBe(false);
  });

  test('should reject long address', () => {
    const result = AddressSchema.safeParse('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb922666');
    expect(result.success).toBe(false);
  });

  test('should reject non-hex characters', () => {
    const result = AddressSchema.safeParse('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb9226g');
    expect(result.success).toBe(false);
  });
...
describe('PrivateKeySchema - Private Key Validation', () => {
  test('should accept valid private key', () => {
    const result = PrivateKeySchema.safeParse('0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80');
    expect(result.success).toBe(true);
  });
  ...
  test('should reject short private key', () => {
    const result = PrivateKeySchema.safeParse('0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff8');
    expect(result.success).toBe(false);
  });

  test('should reject long private key', () => {
    const result = PrivateKeySchema.safeParse('0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff800');
    expect(result.success).toBe(false);
  });

  test('should reject private key without prefix', () => {
    const result = PrivateKeySchema.safeParse('ac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80');
    expect(result.success).toBe(false);
  });
});
...
describe('TxHashSchema - Transaction Hash Validation', () => {
  test('should accept valid transaction hash', () => {
    const result = TxHashSchema.safeParse('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef');
    expect(result.success).toBe(true);
  });

  test('should reject short hash', () => {
    const result = TxHashSchema.safeParse('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcde');
    expect(result.success).toBe(false);
  });

  test('should reject long hash', () => {
    const result = TxHashSchema.safeParse('0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef0');
    expect(result.success).toBe(false);
  });
});
...
describe('Schema Edge Cases', () => {
  ...
  test('AddressSchema should handle mixed case boundary', () => {
    ...
    const result = AddressSchema.safeParse('0xAaBbCcDdEeFf0011223344556677889900aAbBcC');
    expect(result.success).toBe(true);
  });
