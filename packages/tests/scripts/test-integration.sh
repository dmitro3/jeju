...
# These are Anvil default test accounts with PUBLICLY KNOWN private keys.
# NEVER use these on mainnet or any network with real funds.
# See: https://book.getfoundry.sh/anvil/#default-addresses
...
echo "Signing batch..."
# Anvil test accounts (publicly known - DO NOT use on mainnet)
