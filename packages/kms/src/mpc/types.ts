...
const MPC_CONFIGS = {
  localnet: { threshold: 2, totalParties: 3, sessionTimeout: 30_000, maxConcurrentSessions: 100, requireAttestation: false, minPartyStake: 0n },
  testnet: { threshold: 2, totalParties: 3, sessionTimeout: 60_000, maxConcurrentSessions: 50, requireAttestation: true, minPartyStake: 100_000_000_000_000_000n },
  mainnet: { threshold: 3, totalParties: 5, sessionTimeout: 120_000, maxConcurrentSessions: 25, requireAttestation: true, minPartyStake: 1_000_000_000_000_000_000n },
} as const;

export function getMPCConfig(network: MPCCoordinatorConfig['network']): MPCCoordinatorConfig {
